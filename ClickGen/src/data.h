...
class ScalarVar : public Data {
  public:
    ...
    static std::shared_ptr<ScalarVar> createLocal();
    static std::shared_ptr<ScalarVar> selectHeaderField(std::shared_ptr<PopulateCtx> ctx, IntTypeID &type_id_below, bool isTo=false);
    static std::shared_ptr<ScalarVar> selectVar(std::shared_ptr<PopulateCtx> ctx, IntTypeID &type_id_below);
    static std::string compDistr(std::shared_ptr<PopulateCtx> ctx, HeaderType header_type, bool isTo);
