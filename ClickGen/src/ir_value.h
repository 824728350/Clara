...
#define OperatorWrapper(__foo__, __type_id__)                                  \
    do {                                                                       \
        switch (__type_id__) {                                                     \
            OperatorWrapperCase(IntTypeID::SCHAR,  __foo__<TypeSChar::value_type>)\
            OperatorWrapperCase(IntTypeID::UCHAR,  __foo__<TypeUChar::value_type>)\
            OperatorWrapperCase(IntTypeID::SHORT,  __foo__<TypeSShort::value_type>)\
            OperatorWrapperCase(IntTypeID::USHORT,  __foo__<TypeUShort::value_type>)\
