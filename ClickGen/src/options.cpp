...
std::vector<OptionDescr> yarpgen::OptionParser::options_set{
    ...
    {OptionKind::OUT_DIR,
     ...
     ".",
     {}},
    {OptionKind::FILE_NAME,
     "-n",
     "--file-name",
     true,
     "The file name of the generated program",
     "File name parse Error",
     OptionParser::parseFileName,
     ".",
     {}},
...
void OptionParser::parseFileName(std::string val) {
    Options &options = Options::getInstance();
    options.setFileName(std::move(val));
}
