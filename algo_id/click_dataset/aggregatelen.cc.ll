; ModuleID = '../../click/elements/analysis/aggregatelen.cc'
source_filename = "../../click/elements/analysis/aggregatelen.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.AggregateLength = type { %class.Element.base, i8, [3 x i8] }
...
$_ZNK15AggregateLength10class_nameEv = comdat any

$_ZNK15AggregateLength10port_countEv = comdat any
...
@_ZTV15AggregateLength = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI15AggregateLength to i8*), i8* bitcast (void (%class.AggregateLength*)* @_ZN15AggregateLengthD1Ev to i8*), i8* bitcast (void (%class.AggregateLength*)* @_ZN15AggregateLengthD0Ev to i8*), i8* bitcast (void (%class.AggregateLength*, i32, %class.Packet*)* @_ZN15AggregateLength4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.AggregateLength*, i32)* @_ZN15AggregateLength4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.AggregateLength*)* @_ZNK15AggregateLength10class_nameEv to i8*), i8* bitcast (i8* (%class.AggregateLength*)* @_ZNK15AggregateLength10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.AggregateLength*, %class.Vector*, %class.ErrorHandler*)* @_ZN15AggregateLength9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [3 x i8] c"IP\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS15AggregateLength = constant [18 x i8] c"15AggregateLength\00"
@_ZTI7Element = external constant i8*
@_ZTI15AggregateLength = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @_ZTS15AggregateLength, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.7 = private unnamed_addr constant [16 x i8] c"AggregateLength\00", align 1
...
@_ZN15AggregateLengthC1Ev = alias void (%class.AggregateLength*), void (%class.AggregateLength*)* @_ZN15AggregateLengthC2Ev
@_ZN15AggregateLengthD1Ev = alias void (%class.AggregateLength*), void (%class.AggregateLength*)* @_ZN15AggregateLengthD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN15AggregateLengthC2Ev(%class.AggregateLength*) unnamed_addr #0 align 2 {
  %2 = alloca %class.AggregateLength*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %2, align 8
  %3 = load %class.AggregateLength*, %class.AggregateLength** %2, align 8
  %4 = bitcast %class.AggregateLength* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.AggregateLength* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV15AggregateLength, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
...
define void @_ZN15AggregateLengthD2Ev(%class.AggregateLength*) unnamed_addr #2 align 2 {
  %2 = alloca %class.AggregateLength*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %2, align 8
  %3 = load %class.AggregateLength*, %class.AggregateLength** %2, align 8
  %4 = bitcast %class.AggregateLength* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN15AggregateLengthD0Ev(%class.AggregateLength*) unnamed_addr #2 align 2 {
  %2 = alloca %class.AggregateLength*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %2, align 8
  %3 = load %class.AggregateLength*, %class.AggregateLength** %2, align 8
  call void @_ZN15AggregateLengthD1Ev(%class.AggregateLength* %3) #7
  %4 = bitcast %class.AggregateLength* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN15AggregateLength9configureER6VectorI6StringEP12ErrorHandler(%class.AggregateLength*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca i32, align 4
  %5 = alloca %class.AggregateLength*, align 8
  %6 = alloca %class.Vector*, align 8
  %7 = alloca %class.ErrorHandler*, align 8
  %8 = alloca %class.Args, align 8
  %9 = alloca i8*
  %10 = alloca i32
  store %class.AggregateLength* %0, %class.AggregateLength** %5, align 8
  store %class.Vector* %1, %class.Vector** %6, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %7, align 8
  %11 = load %class.AggregateLength*, %class.AggregateLength** %5, align 8
  %12 = getelementptr inbounds %class.AggregateLength, %class.AggregateLength* %11, i32 0, i32 1
  store i8 0, i8* %12, align 4
  %13 = load %class.Vector*, %class.Vector** %6, align 8
  %14 = bitcast %class.AggregateLength* %11 to %class.Element*
  ...
  %16 = getelementptr inbounds %class.AggregateLength, %class.AggregateLength* %11, i32 0, i32 1
  %17 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readIbEERS_PKcRT_(%class.Args* %8, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* dereferenceable(1) %16)
...
; <label>:20:                                     ; preds = %18
  ...
  call void @_ZN4ArgsD1Ev(%class.Args* %8) #7
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN15AggregateLength10bad_packetEP6Packet(%class.AggregateLength*, %class.Packet*) #0 align 2 {
  %3 = alloca %class.AggregateLength*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.AggregateLength*, %class.AggregateLength** %3, align 8
  %6 = bitcast %class.AggregateLength* %5 to %class.Element*
  %7 = call i32 @_ZNK7Element8noutputsEv(%class.Element* %6)
  %8 = icmp eq i32 %7, 2
  br i1 %8, label %9, label %13

; <label>:9:                                      ; preds = %2
  %10 = bitcast %class.AggregateLength* %5 to %class.Element*
  %11 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %10, i32 1)
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN15AggregateLength13handle_packetEP6Packet(%class.AggregateLength*, %class.Packet*) #0 align 2 {
  %3 = alloca %class.Packet*, align 8
  %4 = alloca %class.AggregateLength*, align 8
  %5 = alloca %class.Packet*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  store %class.AggregateLength* %0, %class.AggregateLength** %4, align 8
  store %class.Packet* %1, %class.Packet** %5, align 8
  %8 = load %class.AggregateLength*, %class.AggregateLength** %4, align 8
  %9 = getelementptr inbounds %class.AggregateLength, %class.AggregateLength* %8, i32 0, i32 1
...
; <label>:15:                                     ; preds = %12
  ...
  %17 = call %class.Packet* @_ZN15AggregateLength10bad_packetEP6Packet(%class.AggregateLength* %8, %class.Packet* %16)
  store %class.Packet* %17, %class.Packet** %3, align 8
  br label %38

; <label>:18:                                     ; preds = %12, %2
  %19 = getelementptr inbounds %class.AggregateLength, %class.AggregateLength* %8, i32 0, i32 1
...
; <label>:22:                                     ; preds = %18
  ...
  %24 = call i32 @_ZNK6Packet21network_header_offsetEv(%class.Packet* %23)
...
; <label>:27:                                     ; preds = %26
  ...
  %33 = call i32 @_ZNK6Packet8anno_u32Ei(%class.Packet* %32, i32 28)
  %34 = add i32 %31, %33
  store i32 %34, i32* %7, align 4
  %35 = load %class.Packet*, %class.Packet** %5, align 8
  %36 = load i32, i32* %7, align 4
  call void @_ZN6Packet12set_anno_u32Eij(%class.Packet* %35, i32 20, i32 %36)
  %37 = load %class.Packet*, %class.Packet** %5, align 8
  store %class.Packet* %37, %class.Packet** %3, align 8
  br label %38

; <label>:38:                                     ; preds = %27, %15
  %39 = load %class.Packet*, %class.Packet** %3, align 8
  ret %class.Packet* %39
}
...
; <label>:16:                                     ; preds = %13
  call void @__assert_fail(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i32 0, i32 0), i32 551, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZN6Packet12set_anno_u32Eij, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %18
...
; Function Attrs: noinline optnone uwtable
define void @_ZN15AggregateLength4pushEiP6Packet(%class.AggregateLength*, i32, %class.Packet*) unnamed_addr #0 align 2 {
  %4 = alloca %class.AggregateLength*, align 8
  %5 = alloca i32, align 4
  ...
  %10 = call %class.Packet* @_ZN15AggregateLength13handle_packetEP6Packet(%class.AggregateLength* %8, %class.Packet* %9)
...
; <label>:13:                                     ; preds = %3
  %14 = bitcast %class.AggregateLength* %8 to %class.Element*
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN15AggregateLength4pullEi(%class.AggregateLength*, i32) unnamed_addr #0 align 2 {
  %3 = alloca %class.AggregateLength*, align 8
  %4 = alloca i32, align 4
  %5 = alloca %class.Packet*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %3, align 8
  store i32 %1, i32* %4, align 4
  %6 = load %class.AggregateLength*, %class.AggregateLength** %3, align 8
  %7 = bitcast %class.AggregateLength* %6 to %class.Element*
...
; <label>:12:                                     ; preds = %2
  %13 = load %class.Packet*, %class.Packet** %5, align 8
  %14 = call %class.Packet* @_ZN15AggregateLength13handle_packetEP6Packet(%class.AggregateLength* %6, %class.Packet* %13)
...
; <label>:9:                                      ; preds = %1
  call void @__assert_fail(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i32 657, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pullEv, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %11
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK15AggregateLength10class_nameEv(%class.AggregateLength*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.AggregateLength*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %2, align 8
  %3 = load %class.AggregateLength*, %class.AggregateLength** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK15AggregateLength10port_countEv(%class.AggregateLength*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.AggregateLength*, align 8
  store %class.AggregateLength* %0, %class.AggregateLength** %2, align 8
  %3 = load %class.AggregateLength*, %class.AggregateLength** %2, align 8
