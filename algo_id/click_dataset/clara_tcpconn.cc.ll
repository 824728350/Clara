; ModuleID = '../../click/elements/local/clara_tcpconn.cc'
source_filename = "../../click/elements/local/clara_tcpconn.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.ClaraTCPConn = type { %class.Element.base, i8, %struct.ClaraDemuxHash, i32, [4 x i8] }
...
$_ZNK12ClaraTCPConn10class_nameEv = comdat any

$_ZNK12ClaraTCPConn10port_countEv = comdat any
...
@_ZTV12ClaraTCPConn = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI12ClaraTCPConn to i8*), i8* bitcast (void (%class.ClaraTCPConn*)* @_ZN12ClaraTCPConnD1Ev to i8*), i8* bitcast (void (%class.ClaraTCPConn*)* @_ZN12ClaraTCPConnD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.ClaraTCPConn*, %class.Packet*)* @_ZN12ClaraTCPConn13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.ClaraTCPConn*)* @_ZNK12ClaraTCPConn10class_nameEv to i8*), i8* bitcast (i8* (%class.ClaraTCPConn*)* @_ZNK12ClaraTCPConn10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.ClaraTCPConn*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN12ClaraTCPConn9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
...
@.str.3 = private unnamed_addr constant [44 x i8] c"../../click/elements/local/clara_tcpconn.cc\00", align 1
@__PRETTY_FUNCTION__._ZN12ClaraTCPConn13simple_actionEP6Packet = private unnamed_addr constant [54 x i8] c"virtual Packet *ClaraTCPConn::simple_action(Packet *)\00", align 1
@.str.4 = private unnamed_addr constant [18 x i8] c"Clara TCPConn -> \00", align 1
...
@_ZTS12ClaraTCPConn = constant [15 x i8] c"12ClaraTCPConn\00"
@_ZTI7Element = external constant i8*
@_ZTI12ClaraTCPConn = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @_ZTS12ClaraTCPConn, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.13 = private unnamed_addr constant [13 x i8] c"ClaraTCPConn\00", align 1
@_ZN7Element9PORTS_1_1E = external constant [0 x i8], align 1
@.str.14 = private unnamed_addr constant [15 x i8] c"invalid number\00", align 1

@_ZN12ClaraTCPConnC1Ev = alias void (%class.ClaraTCPConn*), void (%class.ClaraTCPConn*)* @_ZN12ClaraTCPConnC2Ev
@_ZN12ClaraTCPConnD1Ev = alias void (%class.ClaraTCPConn*), void (%class.ClaraTCPConn*)* @_ZN12ClaraTCPConnD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN12ClaraTCPConnC2Ev(%class.ClaraTCPConn*) unnamed_addr #0 align 2 {
  %2 = alloca %class.ClaraTCPConn*, align 8
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %2, align 8
  %3 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %2, align 8
  %4 = bitcast %class.ClaraTCPConn* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.ClaraTCPConn* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12ClaraTCPConn, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  %6 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %3, i32 0, i32 1
  store i8 1, i8* %6, align 4
  %7 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %3, i32 0, i32 2
  ret void
}
...
define void @_ZN12ClaraTCPConnD2Ev(%class.ClaraTCPConn*) unnamed_addr #2 align 2 {
  %2 = alloca %class.ClaraTCPConn*, align 8
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %2, align 8
  %3 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %2, align 8
  %4 = bitcast %class.ClaraTCPConn* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN12ClaraTCPConnD0Ev(%class.ClaraTCPConn*) unnamed_addr #2 align 2 {
  %2 = alloca %class.ClaraTCPConn*, align 8
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %2, align 8
  %3 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %2, align 8
  call void @_ZN12ClaraTCPConnD1Ev(%class.ClaraTCPConn* %3) #9
  %4 = bitcast %class.ClaraTCPConn* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12ClaraTCPConn9configureER6VectorI6StringEP12ErrorHandler(%class.ClaraTCPConn*, %class.Vector.0* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca i32, align 4
  %5 = alloca %class.ClaraTCPConn*, align 8
  %6 = alloca %class.Vector.0*, align 8
  %7 = alloca %class.ErrorHandler*, align 8
  %8 = alloca %class.Args, align 8
  %9 = alloca i8*
  %10 = alloca i32
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %5, align 8
  store %class.Vector.0* %1, %class.Vector.0** %6, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %7, align 8
  %11 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %5, align 8
  %12 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %11, i32 0, i32 3
  store i32 0, i32* %12, align 8
  %13 = load %class.Vector.0*, %class.Vector.0** %6, align 8
  %14 = bitcast %class.ClaraTCPConn* %11 to %class.Element*
  ...
  %16 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %11, i32 0, i32 1
...
; <label>:18:                                     ; preds = %3
  %19 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %11, i32 0, i32 3
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN12ClaraTCPConn13simple_actionEP6Packet(%class.ClaraTCPConn*, %class.Packet*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca %class.Packet*, align 8
  %4 = alloca %class.ClaraTCPConn*, align 8
  ...
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %4, align 8
  store %class.Packet* %1, %class.Packet** %5, align 8
  %22 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %4, align 8
...
; <label>:26:                                     ; preds = %2
  call void @__assert_fail(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i32 0, i32 0), i32 38, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__PRETTY_FUNCTION__._ZN12ClaraTCPConn13simple_actionEP6Packet, i32 0, i32 0)) #11
  unreachable
                                                  ; No predecessors!
  br label %28

; <label>:28:                                     ; preds = %27, %25
  %29 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 1
...
; <label>:35:                                     ; preds = %34
  ...
  %36 = bitcast %class.ClaraTCPConn* %22 to %class.Element*
...
; <label>:51:                                     ; preds = %269, %266, %264, %261, %259, %256, %254, %234, %66, %55, %40, %38, %35
...
; <label>:104:                                    ; preds = %231, %70
  %105 = load i32, i32* %19, align 4
  %106 = icmp ult i32 %105, 16
  br i1 %106, label %107, label %234

; <label>:107:                                    ; preds = %104
  %108 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
...
; <label>:121:                                    ; preds = %107
  %122 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %123 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %122, i32 0, i32 0
  %124 = load volatile i32, i32* %17, align 4
  %125 = zext i32 %124 to i64
  %126 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %123, i64 0, i64 %125
  %127 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %126, i32 0, i32 0
  %128 = load i32, i32* %19, align 4
  %129 = zext i32 %128 to i64
  %130 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %127, i64 0, i64 %129
  %131 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %130, i32 0, i32 0
  %132 = getelementptr inbounds [6 x i32], [6 x i32]* %131, i64 0, i64 1
  %133 = load i32, i32* %132, align 4
  %134 = icmp eq i32 %133, 0
  br i1 %134, label %135, label %230

; <label>:135:                                    ; preds = %121
  %136 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %137 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %136, i32 0, i32 0
  %138 = load volatile i32, i32* %17, align 4
  %139 = zext i32 %138 to i64
  %140 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %137, i64 0, i64 %139
  %141 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %140, i32 0, i32 0
  %142 = load i32, i32* %19, align 4
  %143 = zext i32 %142 to i64
  %144 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %141, i64 0, i64 %143
  %145 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %144, i32 0, i32 0
...
; <label>:149:                                    ; preds = %135
  %150 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %151 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %150, i32 0, i32 0
  %152 = load volatile i32, i32* %17, align 4
  %153 = zext i32 %152 to i64
  %154 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %151, i64 0, i64 %153
  %155 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %154, i32 0, i32 0
  %156 = load i32, i32* %19, align 4
  %157 = zext i32 %156 to i64
  %158 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %155, i64 0, i64 %157
  %159 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %158, i32 0, i32 0
...
; <label>:163:                                    ; preds = %149
  %164 = getelementptr inbounds [4 x i32], [4 x i32]* %20, i64 0, i64 0
  %165 = load i32, i32* %164, align 16
  %166 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %167 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %166, i32 0, i32 0
  %168 = load volatile i32, i32* %17, align 4
  %169 = zext i32 %168 to i64
  %170 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %167, i64 0, i64 %169
  %171 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %170, i32 0, i32 0
  %172 = load i32, i32* %19, align 4
  %173 = zext i32 %172 to i64
  %174 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %171, i64 0, i64 %173
  %175 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %174, i32 0, i32 0
  ...
  %179 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %180 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %179, i32 0, i32 0
  %181 = load volatile i32, i32* %17, align 4
  %182 = zext i32 %181 to i64
  %183 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %180, i64 0, i64 %182
  %184 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %183, i32 0, i32 0
  %185 = load i32, i32* %19, align 4
  %186 = zext i32 %185 to i64
  %187 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %184, i64 0, i64 %186
  %188 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %187, i32 0, i32 0
  %189 = getelementptr inbounds [6 x i32], [6 x i32]* %188, i64 0, i64 1
  store i32 %178, i32* %189, align 4
  %190 = getelementptr inbounds [4 x i32], [4 x i32]* %20, i64 0, i64 2
  %191 = load i32, i32* %190, align 8
  %192 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %193 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %192, i32 0, i32 0
  %194 = load volatile i32, i32* %17, align 4
  %195 = zext i32 %194 to i64
  %196 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %193, i64 0, i64 %195
  %197 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %196, i32 0, i32 0
  %198 = load i32, i32* %19, align 4
  %199 = zext i32 %198 to i64
  %200 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %197, i64 0, i64 %199
  %201 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %200, i32 0, i32 0
  %202 = getelementptr inbounds [6 x i32], [6 x i32]* %201, i64 0, i64 2
  store i32 %191, i32* %202, align 4
  %203 = getelementptr inbounds [4 x i32], [4 x i32]* %20, i64 0, i64 3
  %204 = load i32, i32* %203, align 4
  %205 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %206 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %205, i32 0, i32 0
  %207 = load volatile i32, i32* %17, align 4
  %208 = zext i32 %207 to i64
  %209 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %206, i64 0, i64 %208
  %210 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %209, i32 0, i32 0
  %211 = load i32, i32* %19, align 4
  %212 = zext i32 %211 to i64
  %213 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %210, i64 0, i64 %212
  %214 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %213, i32 0, i32 0
  %215 = getelementptr inbounds [6 x i32], [6 x i32]* %214, i64 0, i64 3
  store i32 %204, i32* %215, align 4
  %216 = load %struct.click_tcp*, %struct.click_tcp** %16, align 8
  %217 = getelementptr inbounds %struct.click_tcp, %struct.click_tcp* %216, i32 0, i32 1
  %218 = load i16, i16* %217, align 2
  %219 = zext i16 %218 to i32
  %220 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 2
  %221 = getelementptr inbounds %struct.ClaraDemuxHash, %struct.ClaraDemuxHash* %220, i32 0, i32 0
  %222 = load volatile i32, i32* %17, align 4
  %223 = zext i32 %222 to i64
  %224 = getelementptr inbounds [31 x %struct.demux_bucket_list], [31 x %struct.demux_bucket_list]* %221, i64 0, i64 %223
  %225 = getelementptr inbounds %struct.demux_bucket_list, %struct.demux_bucket_list* %224, i32 0, i32 0
  %226 = load i32, i32* %19, align 4
  %227 = zext i32 %226 to i64
  %228 = getelementptr inbounds [50 x %struct.demux_bucket_entry], [50 x %struct.demux_bucket_entry]* %225, i64 0, i64 %227
  %229 = getelementptr inbounds %struct.demux_bucket_entry, %struct.demux_bucket_entry* %228, i32 0, i32 1
  store i32 %219, i32* %229, align 4
  br label %234

; <label>:230:                                    ; preds = %149, %135, %121, %107
  br label %231
...
; <label>:234:                                    ; preds = %163, %104
  %235 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 3
  %236 = load i32, i32* %235, align 8
  %237 = mul i32 12, %236
  %238 = load i32, i32* %10, align 4
  %239 = add i32 %238, %237
  store i32 %239, i32* %10, align 4
  %240 = getelementptr inbounds %class.ClaraTCPConn, %class.ClaraTCPConn* %22, i32 0, i32 3
  ...
  %249 = or i32 %246, %248
  %250 = load %struct.click_ip*, %struct.click_ip** %15, align 8
  %251 = getelementptr inbounds %struct.click_ip, %struct.click_ip* %250, i32 0, i32 8
  %252 = getelementptr inbounds %struct.in_addr, %struct.in_addr* %251, i32 0, i32 0
  store i32 %249, i32* %252, align 4
  %253 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumPKc(%class.StringAccum* dereferenceable(16) %6, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4, i32 0, i32 0))
          to label %254 unwind label %51

; <label>:254:                                    ; preds = %234
  %255 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumPKc(%class.StringAccum* dereferenceable(16) %253, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0))
          to label %256 unwind label %51

; <label>:256:                                    ; preds = %254
  %257 = load i32, i32* %10, align 4
  %258 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumi(%class.StringAccum* dereferenceable(16) %255, i32 %257)
          to label %259 unwind label %51

; <label>:259:                                    ; preds = %256
  %260 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumPKc(%class.StringAccum* dereferenceable(16) %258, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.6, i32 0, i32 0))
          to label %261 unwind label %51

; <label>:261:                                    ; preds = %259
  %262 = load i32, i32* %11, align 4
  %263 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumi(%class.StringAccum* dereferenceable(16) %260, i32 %262)
          to label %264 unwind label %51

; <label>:264:                                    ; preds = %261
  %265 = invoke dereferenceable(16) %class.StringAccum* @_ZlsR11StringAccumPKc(%class.StringAccum* dereferenceable(16) %263, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
          to label %266 unwind label %51

; <label>:266:                                    ; preds = %264
  %267 = load %class.ErrorHandler*, %class.ErrorHandler** %12, align 8
  %268 = invoke i8* @_ZN11StringAccum5c_strEv(%class.StringAccum* %6)
          to label %269 unwind label %51

; <label>:269:                                    ; preds = %266
  invoke void (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler7messageEPKcz(%class.ErrorHandler* %267, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0), i8* %268)
          to label %270 unwind label %51

; <label>:270:                                    ; preds = %269
  %271 = load %class.WritablePacket*, %class.WritablePacket** %13, align 8
  %272 = bitcast %class.WritablePacket* %271 to %class.Packet*
  store %class.Packet* %272, %class.Packet** %3, align 8
  store i32 1, i32* %14, align 4
  br label %273

; <label>:273:                                    ; preds = %270, %46
  call void @_ZN6StringD2Ev(%class.String* %7) #9
  call void @_ZN11StringAccumD2Ev(%class.StringAccum* %6) #9
  br label %275

; <label>:274:                                    ; preds = %51, %47
  call void @_ZN11StringAccumD2Ev(%class.StringAccum* %6) #9
  br label %277

; <label>:275:                                    ; preds = %273, %32
  %276 = load %class.Packet*, %class.Packet** %3, align 8
  ret %class.Packet* %276
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12ClaraTCPConn10class_nameEv(%class.ClaraTCPConn*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ClaraTCPConn*, align 8
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %2, align 8
  %3 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %2, align 8
  ret i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.13, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12ClaraTCPConn10port_countEv(%class.ClaraTCPConn*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ClaraTCPConn*, align 8
  store %class.ClaraTCPConn* %0, %class.ClaraTCPConn** %2, align 8
  %3 = load %class.ClaraTCPConn*, %class.ClaraTCPConn** %2, align 8
