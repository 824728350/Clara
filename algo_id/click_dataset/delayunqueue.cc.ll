; ModuleID = '../../click/elements/standard/delayunqueue.cc'
source_filename = "../../click/elements/standard/delayunqueue.cc"
...
@_ZTS12DelayUnqueue = constant [15 x i8] c"12DelayUnqueue\00"
@_ZTI7Element = external constant i8*
@_ZTI12DelayUnqueue = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @_ZTS12DelayUnqueue, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@_ZN12DelayUnqueueC1Ev = alias void (%class.DelayUnqueue*), void (%class.DelayUnqueue*)* @_ZN12DelayUnqueueC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN12DelayUnqueueC2Ev(%class.DelayUnqueue*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.DelayUnqueue*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %5 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
  %6 = bitcast %class.DelayUnqueue* %5 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %6)
  %7 = bitcast %class.DelayUnqueue* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12DelayUnqueue, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 1
  store %class.Packet* null, %class.Packet** %8, align 8
  %9 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 2
  invoke void @_ZN9TimestampC2Ev(%class.Timestamp* %9)
          to label %10 unwind label %19

; <label>:10:                                     ; preds = %1
  %11 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 3
  %12 = bitcast %class.DelayUnqueue* %5 to %class.Element*
  invoke void @_ZN4TaskC2EP7Element(%class.Task* %11, %class.Element* %12)
          to label %13 unwind label %19

; <label>:13:                                     ; preds = %10
  %14 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 4
  %15 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 3
  invoke void @_ZN5TimerC1EP4Task(%class.Timer* %14, %class.Task* %15)
          to label %16 unwind label %23

; <label>:16:                                     ; preds = %13
  %17 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 5
...
; <label>:27:                                     ; preds = %16
  ...
  call void @_ZN5TimerD2Ev(%class.Timer* %14) #8
  br label %31

; <label>:31:                                     ; preds = %27, %23
  call void @_ZN4TaskD1Ev(%class.Task* %11) #8
  br label %32

; <label>:32:                                     ; preds = %31, %19
  %33 = bitcast %class.DelayUnqueue* %5 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %33) #8
  br label %34
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12DelayUnqueue9configureER6VectorI6StringEP12ErrorHandler(%class.DelayUnqueue*, %class.Vector.7* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.DelayUnqueue*, align 8
  %5 = alloca %class.Vector.7*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %4, align 8
  store %class.Vector.7* %1, %class.Vector.7** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.DelayUnqueue*, %class.DelayUnqueue** %4, align 8
  %11 = load %class.Vector.7*, %class.Vector.7** %5, align 8
  %12 = bitcast %class.DelayUnqueue* %10 to %class.Element*
  %13 = load %class.ErrorHandler*, %class.ErrorHandler** %6, align 8
  call void @_ZN4ArgsC1ERK6VectorI6StringEPK7ElementP12ErrorHandler(%class.Args* %7, %class.Vector.7* dereferenceable(16) %11, %class.Element* %12, %class.ErrorHandler* %13)
  %14 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %10, i32 0, i32 2
  %15 = invoke dereferenceable(112) %class.Args* @_ZN4Args7read_mpI9TimestampEERS_PKcRT_(%class.Args* %7, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), %class.Timestamp* dereferenceable(8) %14)
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12DelayUnqueue10initializeEP12ErrorHandler(%class.DelayUnqueue*, %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca %class.DelayUnqueue*, align 8
  %4 = alloca %class.ErrorHandler*, align 8
  %5 = alloca %class.NotifierSignal, align 8
  %6 = alloca i8*
  %7 = alloca i32
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %3, align 8
  store %class.ErrorHandler* %1, %class.ErrorHandler** %4, align 8
  %8 = load %class.DelayUnqueue*, %class.DelayUnqueue** %3, align 8
  %9 = bitcast %class.DelayUnqueue* %8 to %class.Element*
  %10 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %8, i32 0, i32 3
  ...
  %12 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %8, i32 0, i32 4
  %13 = bitcast %class.DelayUnqueue* %8 to %class.Element*
  call void @_ZN5Timer10initializeEP7Elementb(%class.Timer* %12, %class.Element* %13, i1 zeroext false)
  %14 = bitcast %class.DelayUnqueue* %8 to %class.Element*
  %15 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %8, i32 0, i32 3
  ...
  %16 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %8, i32 0, i32 5
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12DelayUnqueue7cleanupEN7Element12CleanupStageE(%class.DelayUnqueue*, i32) unnamed_addr #0 align 2 {
  %3 = alloca %class.DelayUnqueue*, align 8
  %4 = alloca i32, align 4
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %3, align 8
  store i32 %1, i32* %4, align 4
  %5 = load %class.DelayUnqueue*, %class.DelayUnqueue** %3, align 8
  %6 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 1
  %7 = load %class.Packet*, %class.Packet** %6, align 8
  %8 = icmp ne %class.Packet* %7, null
  br i1 %8, label %9, label %12

; <label>:9:                                      ; preds = %2
  %10 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %5, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define zeroext i1 @_ZN12DelayUnqueue8run_taskEP4Task(%class.DelayUnqueue*, %class.Task*) unnamed_addr #0 align 2 {
  %3 = alloca i1, align 1
  %4 = alloca %class.DelayUnqueue*, align 8
  %5 = alloca %class.Task*, align 8
  %6 = alloca i8, align 1
  ...
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %4, align 8
  store %class.Task* %1, %class.Task** %5, align 8
  %11 = load %class.DelayUnqueue*, %class.DelayUnqueue** %4, align 8
  store i8 0, i8* %6, align 1
  br label %12

; <label>:12:                                     ; preds = %50, %2
  %13 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  %14 = load %class.Packet*, %class.Packet** %13, align 8
  %15 = icmp ne %class.Packet* %14, null
  br i1 %15, label %38, label %16

; <label>:16:                                     ; preds = %12
  %17 = bitcast %class.DelayUnqueue* %11 to %class.Element*
  %18 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element5inputEi(%class.Element* %17, i32 0)
  %19 = call %class.Packet* @_ZNK7Element4Port4pullEv(%"class.Element::Port"* %18)
  %20 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  store %class.Packet* %19, %class.Packet** %20, align 8
  %21 = icmp ne %class.Packet* %19, null
  br i1 %21, label %22, label %38

; <label>:22:                                     ; preds = %16
  %23 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  %24 = load %class.Packet*, %class.Packet** %23, align 8
  %25 = call dereferenceable(8) %class.Timestamp* @_ZN6Packet14timestamp_annoEv(%class.Packet* %24)
  %26 = call i32 @_ZNK9Timestamp3secEv(%class.Timestamp* %25)
  %27 = icmp ne i32 %26, 0
  br i1 %27, label %32, label %28

; <label>:28:                                     ; preds = %22
  %29 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  ...
  call void @_ZN9Timestamp10assign_nowEv(%class.Timestamp* %31)
  br label %32

; <label>:32:                                     ; preds = %28, %22
  %33 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 2
  %34 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  ...
  %37 = call dereferenceable(8) %class.Timestamp* @_ZpLR9TimestampRKS_(%class.Timestamp* dereferenceable(8) %36, %class.Timestamp* dereferenceable(8) %33)
  br label %38

; <label>:38:                                     ; preds = %32, %16, %12
  %39 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
...
; <label>:42:                                     ; preds = %38
  ...
  %46 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  ...
  %49 = call zeroext i1 @_ZleRK9TimestampS1_(%class.Timestamp* dereferenceable(8) %48, %class.Timestamp* dereferenceable(8) %7)
  br i1 %49, label %50, label %56

; <label>:50:                                     ; preds = %42
  %51 = bitcast %class.DelayUnqueue* %11 to %class.Element*
  %52 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %51, i32 0)
  %53 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  %54 = load %class.Packet*, %class.Packet** %53, align 8
  call void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* %52, %class.Packet* %54)
  %55 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  store %class.Packet* null, %class.Packet** %55, align 8
  store i8 1, i8* %6, align 1
  br label %12

; <label>:56:                                     ; preds = %42
  %57 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 1
  %58 = load %class.Packet*, %class.Packet** %57, align 8
  %59 = call dereferenceable(8) %class.Timestamp* @_ZN6Packet14timestamp_annoEv(%class.Packet* %58)
  %60 = bitcast %class.Timestamp* %9 to i8*
  %61 = bitcast %class.Timestamp* %59 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %60, i8* %61, i64 8, i32 8, i1 false)
  %62 = call i64 @_ZN5Timer10adjustmentEv()
  %63 = getelementptr inbounds %class.Timestamp, %class.Timestamp* %10, i32 0, i32 0
  %64 = getelementptr inbounds %"union.Timestamp::rep_t", %"union.Timestamp::rep_t"* %63, i32 0, i32 0
  store i64 %62, i64* %64, align 8
  %65 = getelementptr inbounds %class.Timestamp, %class.Timestamp* %9, i32 0, i32 0
  %66 = getelementptr inbounds %"union.Timestamp::rep_t", %"union.Timestamp::rep_t"* %65, i32 0, i32 0
  %67 = load i64, i64* %66, align 8
  %68 = call i64 @_Zmi9TimestampRKS_(i64 %67, %class.Timestamp* dereferenceable(8) %10)
  %69 = getelementptr inbounds %class.Timestamp, %class.Timestamp* %8, i32 0, i32 0
  %70 = getelementptr inbounds %"union.Timestamp::rep_t", %"union.Timestamp::rep_t"* %69, i32 0, i32 0
  store i64 %68, i64* %70, align 8
  %71 = call zeroext i1 @_ZleRK9TimestampS1_(%class.Timestamp* dereferenceable(8) %8, %class.Timestamp* dereferenceable(8) %7)
...
; <label>:73:                                     ; preds = %56
  %74 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 4
  call void @_ZN5Timer11schedule_atERK9Timestamp(%class.Timer* %74, %class.Timestamp* dereferenceable(8) %8)
...
; <label>:76:                                     ; preds = %38
  %77 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 5
  %78 = call { i64, i64 } @_ZNK14NotifierSignalcvMS_KFbvEEv(%class.NotifierSignal* %77)
...
; <label>:83:                                     ; preds = %82, %75
  %84 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %11, i32 0, i32 3
...
; <label>:9:                                      ; preds = %1
  call void @__assert_fail(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i32 0, i32 0), i32 657, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pullEv, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %11
...
; <label>:15:                                     ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i32 0, i32 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %17
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12DelayUnqueue12add_handlersEv(%class.DelayUnqueue*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.DelayUnqueue*, align 8
  %3 = alloca %class.String, align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %6 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
  %7 = bitcast %class.DelayUnqueue* %6 to %class.Element*
  %8 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %6, i32 0, i32 2
  call void @_ZN7Element17add_data_handlersEPKciP9Timestampb(%class.Element* %7, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i32 3, %class.Timestamp* %8, i1 zeroext true)
  %9 = bitcast %class.DelayUnqueue* %6 to %class.Element*
  %10 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %6, i32 0, i32 3
  call void @_ZN6StringC2Ev(%class.String* %3)
  invoke void @_ZN7Element17add_task_handlersEP4TaskRK6String(%class.Element* %9, %class.Task* %10, %class.String* dereferenceable(24) %3)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN12DelayUnqueueD2Ev(%class.DelayUnqueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.DelayUnqueue*, align 8
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %3 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
  %4 = bitcast %class.DelayUnqueue* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12DelayUnqueue, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %4, align 8
  %5 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %3, i32 0, i32 5
  call void @_ZN14NotifierSignalD2Ev(%class.NotifierSignal* %5) #8
  %6 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %3, i32 0, i32 4
  call void @_ZN5TimerD2Ev(%class.Timer* %6) #8
  %7 = getelementptr inbounds %class.DelayUnqueue, %class.DelayUnqueue* %3, i32 0, i32 3
  call void @_ZN4TaskD1Ev(%class.Task* %7) #8
  %8 = bitcast %class.DelayUnqueue* %3 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %8) #8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN12DelayUnqueueD0Ev(%class.DelayUnqueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.DelayUnqueue*, align 8
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %3 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
  call void @_ZN12DelayUnqueueD2Ev(%class.DelayUnqueue* %3) #8
  %4 = bitcast %class.DelayUnqueue* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12DelayUnqueue10class_nameEv(%class.DelayUnqueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.DelayUnqueue*, align 8
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %3 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
  ret i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.8, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12DelayUnqueue10port_countEv(%class.DelayUnqueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.DelayUnqueue*, align 8
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %3 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12DelayUnqueue10processingEv(%class.DelayUnqueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.DelayUnqueue*, align 8
  store %class.DelayUnqueue* %0, %class.DelayUnqueue** %2, align 8
  %3 = load %class.DelayUnqueue*, %class.DelayUnqueue** %2, align 8
