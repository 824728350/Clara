; ModuleID = '../../click/elements/standard/discardnofree.cc'
source_filename = "../../click/elements/standard/discardnofree.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.DiscardNoFree = type { %class.Element.base, %class.Task }
...
$_ZN13DiscardNoFreeD2Ev = comdat any

$_ZN13DiscardNoFreeD0Ev = comdat any

$_ZNK13DiscardNoFree10class_nameEv = comdat any

$_ZNK13DiscardNoFree10port_countEv = comdat any
...
@_ZTV13DiscardNoFree = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13DiscardNoFree to i8*), i8* bitcast (void (%class.DiscardNoFree*)* @_ZN13DiscardNoFreeD2Ev to i8*), i8* bitcast (void (%class.DiscardNoFree*)* @_ZN13DiscardNoFreeD0Ev to i8*), i8* bitcast (void (%class.DiscardNoFree*, i32, %class.Packet*)* @_ZN13DiscardNoFree4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.DiscardNoFree*, %class.Task*)* @_ZN13DiscardNoFree8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.DiscardNoFree*)* @_ZNK13DiscardNoFree10class_nameEv to i8*), i8* bitcast (i8* (%class.DiscardNoFree*)* @_ZNK13DiscardNoFree10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.7*, %class.ErrorHandler*)* @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.DiscardNoFree*)* @_ZN13DiscardNoFree12add_handlersEv to i8*), i8* bitcast (i32 (%class.DiscardNoFree*, %class.ErrorHandler*)* @_ZN13DiscardNoFree10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.7*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS13DiscardNoFree = constant [16 x i8] c"13DiscardNoFree\00"
@_ZTI7Element = external constant i8*
@_ZTI13DiscardNoFree = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13DiscardNoFree, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.5 = private unnamed_addr constant [14 x i8] c"DiscardNoFree\00", align 1
@_ZN7Element9PORTS_1_0E = external constant [0 x i8], align 1

@_ZN13DiscardNoFreeC1Ev = alias void (%class.DiscardNoFree*), void (%class.DiscardNoFree*)* @_ZN13DiscardNoFreeC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN13DiscardNoFreeC2Ev(%class.DiscardNoFree*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.DiscardNoFree*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %5 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
  %6 = bitcast %class.DiscardNoFree* %5 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %6)
  %7 = bitcast %class.DiscardNoFree* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13DiscardNoFree, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.DiscardNoFree, %class.DiscardNoFree* %5, i32 0, i32 1
  %9 = bitcast %class.DiscardNoFree* %5 to %class.Element*
...
; <label>:11:                                     ; preds = %1
  ...
  %15 = bitcast %class.DiscardNoFree* %5 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %15) #7
  br label %16
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN13DiscardNoFree10initializeEP12ErrorHandler(%class.DiscardNoFree*, %class.ErrorHandler*) unnamed_addr #0 align 2 {
  %3 = alloca %class.DiscardNoFree*, align 8
  %4 = alloca %class.ErrorHandler*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %3, align 8
  store %class.ErrorHandler* %1, %class.ErrorHandler** %4, align 8
  %5 = load %class.DiscardNoFree*, %class.DiscardNoFree** %3, align 8
  %6 = bitcast %class.DiscardNoFree* %5 to %class.Element*
  %7 = call zeroext i1 @_ZNK7Element13input_is_pullEi(%class.Element* %6, i32 0)
  br i1 %7, label %8, label %12

; <label>:8:                                      ; preds = %2
  %9 = bitcast %class.DiscardNoFree* %5 to %class.Element*
  %10 = getelementptr inbounds %class.DiscardNoFree, %class.DiscardNoFree* %5, i32 0, i32 1
...
define void @_ZN13DiscardNoFree4pushEiP6Packet(%class.DiscardNoFree*, i32, %class.Packet*) unnamed_addr #3 align 2 {
  %4 = alloca %class.DiscardNoFree*, align 8
  %5 = alloca i32, align 4
  %6 = alloca %class.Packet*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %4, align 8
  store i32 %1, i32* %5, align 4
  store %class.Packet* %2, %class.Packet** %6, align 8
  %7 = load %class.DiscardNoFree*, %class.DiscardNoFree** %4, align 8
  ret void
}

; Function Attrs: noinline optnone uwtable
define zeroext i1 @_ZN13DiscardNoFree8run_taskEP4Task(%class.DiscardNoFree*, %class.Task*) unnamed_addr #0 align 2 {
  %3 = alloca %class.DiscardNoFree*, align 8
  %4 = alloca %class.Task*, align 8
  %5 = alloca %class.Packet*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %3, align 8
  store %class.Task* %1, %class.Task** %4, align 8
  %6 = load %class.DiscardNoFree*, %class.DiscardNoFree** %3, align 8
  %7 = bitcast %class.DiscardNoFree* %6 to %class.Element*
  ...
  %10 = getelementptr inbounds %class.DiscardNoFree, %class.DiscardNoFree* %6, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define void @_ZN13DiscardNoFree12add_handlersEv(%class.DiscardNoFree*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.DiscardNoFree*, align 8
  %3 = alloca %class.String, align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %6 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
  %7 = bitcast %class.DiscardNoFree* %6 to %class.Element*
  %8 = call zeroext i1 @_ZNK7Element13input_is_pullEi(%class.Element* %7, i32 0)
  br i1 %8, label %9, label %17

; <label>:9:                                      ; preds = %1
  %10 = bitcast %class.DiscardNoFree* %6 to %class.Element*
  %11 = getelementptr inbounds %class.DiscardNoFree, %class.DiscardNoFree* %6, i32 0, i32 1
...
; <label>:12:                                     ; preds = %9
  call void @_ZN6StringD2Ev(%class.String* %3) #7
  br label %17
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13DiscardNoFreeD2Ev(%class.DiscardNoFree*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.DiscardNoFree*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %3 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
  %4 = bitcast %class.DiscardNoFree* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13DiscardNoFree, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %4, align 8
  %5 = getelementptr inbounds %class.DiscardNoFree, %class.DiscardNoFree* %3, i32 0, i32 1
  call void @_ZN4TaskD1Ev(%class.Task* %5) #7
  %6 = bitcast %class.DiscardNoFree* %3 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %6) #7
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13DiscardNoFreeD0Ev(%class.DiscardNoFree*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.DiscardNoFree*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %3 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
  call void @_ZN13DiscardNoFreeD2Ev(%class.DiscardNoFree* %3) #7
  %4 = bitcast %class.DiscardNoFree* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13DiscardNoFree10class_nameEv(%class.DiscardNoFree*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.DiscardNoFree*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %3 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13DiscardNoFree10port_countEv(%class.DiscardNoFree*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.DiscardNoFree*, align 8
  store %class.DiscardNoFree* %0, %class.DiscardNoFree** %2, align 8
  %3 = load %class.DiscardNoFree*, %class.DiscardNoFree** %2, align 8
...
; <label>:16:                                     ; preds = %8
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i32 0, i32 0), i32 272, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__PRETTY_FUNCTION__._ZNK6String5derefEv, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %18
