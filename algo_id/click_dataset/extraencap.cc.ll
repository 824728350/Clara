; ModuleID = '../../click/elements/wifi/extraencap.cc'
source_filename = "../../click/elements/wifi/extraencap.cc"
...
%class.ExtraEncap = type { %class.Element.base, i8, [3 x i8] }
...
$_ZNK10ExtraEncap10class_nameEv = comdat any

$_ZNK10ExtraEncap10port_countEv = comdat any

$_ZNK10ExtraEncap10processingEv = comdat any

$_ZNK10ExtraEncap20can_live_reconfigureEv = comdat any
...
@_ZTV10ExtraEncap = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI10ExtraEncap to i8*), i8* bitcast (void (%class.ExtraEncap*)* @_ZN10ExtraEncapD1Ev to i8*), i8* bitcast (void (%class.ExtraEncap*)* @_ZN10ExtraEncapD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.ExtraEncap*, %class.Packet*)* @_ZN10ExtraEncap13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.ExtraEncap*)* @_ZNK10ExtraEncap10class_nameEv to i8*), i8* bitcast (i8* (%class.ExtraEncap*)* @_ZNK10ExtraEncap10port_countEv to i8*), i8* bitcast (i8* (%class.ExtraEncap*)* @_ZNK10ExtraEncap10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.ExtraEncap*, %class.Vector*, %class.ErrorHandler*)* @_ZN10ExtraEncap9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.ExtraEncap*)* @_ZN10ExtraEncap12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.ExtraEncap*)* @_ZNK10ExtraEncap20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [6 x i8] c"DEBUG\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"debug\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS10ExtraEncap = constant [13 x i8] c"10ExtraEncap\00"
@_ZTI7Element = external constant i8*
@_ZTI10ExtraEncap = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @_ZTS10ExtraEncap, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.6 = private unnamed_addr constant [11 x i8] c"ExtraEncap\00", align 1
@_ZN7Element9PORTS_1_1E = external constant [0 x i8], align 1
@_ZN7Element8AGNOSTICE = external constant [0 x i8], align 1

@_ZN10ExtraEncapC1Ev = alias void (%class.ExtraEncap*), void (%class.ExtraEncap*)* @_ZN10ExtraEncapC2Ev
@_ZN10ExtraEncapD1Ev = alias void (%class.ExtraEncap*), void (%class.ExtraEncap*)* @_ZN10ExtraEncapD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN10ExtraEncapC2Ev(%class.ExtraEncap*) unnamed_addr #0 align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  %4 = bitcast %class.ExtraEncap* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.ExtraEncap* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV10ExtraEncap, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
...
define void @_ZN10ExtraEncapD2Ev(%class.ExtraEncap*) unnamed_addr #2 align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  %4 = bitcast %class.ExtraEncap* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN10ExtraEncapD0Ev(%class.ExtraEncap*) unnamed_addr #2 align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  call void @_ZN10ExtraEncapD1Ev(%class.ExtraEncap* %3) #9
  %4 = bitcast %class.ExtraEncap* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN10ExtraEncap9configureER6VectorI6StringEP12ErrorHandler(%class.ExtraEncap*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.ExtraEncap*, align 8
  %5 = alloca %class.Vector*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.ExtraEncap* %0, %class.ExtraEncap** %4, align 8
  store %class.Vector* %1, %class.Vector** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.ExtraEncap*, %class.ExtraEncap** %4, align 8
  %11 = getelementptr inbounds %class.ExtraEncap, %class.ExtraEncap* %10, i32 0, i32 1
  store i8 0, i8* %11, align 4
  %12 = load %class.Vector*, %class.Vector** %5, align 8
  %13 = bitcast %class.ExtraEncap* %10 to %class.Element*
  ...
  %15 = getelementptr inbounds %class.ExtraEncap, %class.ExtraEncap* %10, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN10ExtraEncap13simple_actionEP6Packet(%class.ExtraEncap*, %class.Packet*) unnamed_addr #0 align 2 {
  ...
  %8 = load %class.ExtraEncap*, %class.ExtraEncap** %4, align 8
...
; <label>:15:                                     ; preds = %2
  ...
  %18 = call %class.WritablePacket* @_ZN6Packet4pushEj(%class.Packet* %17, i32 24)
...
; <label>:21:                                     ; preds = %15
  ...
  store %struct.click_wifi_extra* %24, %struct.click_wifi_extra** %7, align 8
  %25 = load %struct.click_wifi_extra*, %struct.click_wifi_extra** %7, align 8
  %26 = bitcast %struct.click_wifi_extra* %25 to i8*
  call void @llvm.memset.p0i8.i64(i8* %26, i8 0, i64 24, i32 1, i1 false)
  ...
  %29 = load %class.WritablePacket*, %class.WritablePacket** %6, align 8
  ...
  %34 = bitcast %struct.click_wifi_extra* %33 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %28, i8* %34, i64 24, i32 1, i1 false)
  %35 = load %struct.click_wifi_extra*, %struct.click_wifi_extra** %7, align 8
  %36 = getelementptr inbounds %struct.click_wifi_extra, %struct.click_wifi_extra* %35, i32 0, i32 0
  store i32 122232833, i32* %36, align 1
  br label %37

; <label>:37:                                     ; preds = %21, %15
...
; Function Attrs: noinline optnone uwtable
define void @_ZN10ExtraEncap12add_handlersEv(%class.ExtraEncap*) unnamed_addr #0 align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  %4 = bitcast %class.ExtraEncap* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZL21ExtraEncap_read_paramP7ElementPv, i32 0, i32 0)
  %5 = bitcast %class.ExtraEncap* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %5, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZL22ExtraEncap_write_paramRK6StringP7ElementPvP12ErrorHandler, i32 0, i32 0)
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define internal void @_ZL21ExtraEncap_read_paramP7ElementPv(%class.String* noalias sret, %class.Element*, i8*) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %class.ExtraEncap*, align 8
  ...
  %11 = bitcast %class.Element* %10 to %class.ExtraEncap*
  store %class.ExtraEncap* %11, %class.ExtraEncap** %6, align 8
...
; <label>:14:                                     ; preds = %3
  %15 = load %class.ExtraEncap*, %class.ExtraEncap** %6, align 8
  %16 = getelementptr inbounds %class.ExtraEncap, %class.ExtraEncap* %15, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define internal i32 @_ZL22ExtraEncap_write_paramRK6StringP7ElementPvP12ErrorHandler(%class.String* dereferenceable(24), %class.Element*, i8*, %class.ErrorHandler*) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %5 = alloca i32, align 4
  %6 = alloca %class.String*, align 8
  %7 = alloca %class.Element*, align 8
  %8 = alloca i8*, align 8
  %9 = alloca %class.ErrorHandler*, align 8
  %10 = alloca %class.ExtraEncap*, align 8
  ...
  %18 = bitcast %class.Element* %17 to %class.ExtraEncap*
  store %class.ExtraEncap* %18, %class.ExtraEncap** %10, align 8
...
; <label>:34:                                     ; preds = %24
  ...
  %37 = load %class.ExtraEncap*, %class.ExtraEncap** %10, align 8
  %38 = getelementptr inbounds %class.ExtraEncap, %class.ExtraEncap* %37, i32 0, i32 1
  %39 = zext i1 %36 to i8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK10ExtraEncap10class_nameEv(%class.ExtraEncap*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  ret i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK10ExtraEncap10port_countEv(%class.ExtraEncap*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK10ExtraEncap10processingEv(%class.ExtraEncap*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr zeroext i1 @_ZNK10ExtraEncap20can_live_reconfigureEv(%class.ExtraEncap*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.ExtraEncap*, align 8
  store %class.ExtraEncap* %0, %class.ExtraEncap** %2, align 8
  %3 = load %class.ExtraEncap*, %class.ExtraEncap** %2, align 8
  ret i1 true
