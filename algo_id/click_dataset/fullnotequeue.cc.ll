; ModuleID = '../../click/elements/standard/fullnotequeue.cc'
source_filename = "../../click/elements/standard/fullnotequeue.cc"
...
@_ZTS13FullNoteQueue = constant [16 x i8] c"13FullNoteQueue\00"
@_ZTI13NotifierQueue = external constant i8*
@_ZTI13FullNoteQueue = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13FullNoteQueue, i32 0, i32 0), i8* bitcast (i8** @_ZTI13NotifierQueue to i8*) }
...
@_ZN13FullNoteQueueC1Ev = alias void (%class.FullNoteQueue*), void (%class.FullNoteQueue*)* @_ZN13FullNoteQueueC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN13FullNoteQueueC2Ev(%class.FullNoteQueue*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.FullNoteQueue*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.FullNoteQueue* %0, %class.FullNoteQueue** %2, align 8
  %5 = load %class.FullNoteQueue*, %class.FullNoteQueue** %2, align 8
  %6 = bitcast %class.FullNoteQueue* %5 to %class.NotifierQueue*
  call void @_ZN13NotifierQueueC2Ev(%class.NotifierQueue* %6)
  %7 = bitcast %class.FullNoteQueue* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13FullNoteQueue, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.FullNoteQueue, %class.FullNoteQueue* %5, i32 0, i32 1
  invoke void @_ZN14ActiveNotifierC1EN8Notifier8SearchOpE(%class.ActiveNotifier* %8, i32 0)
...
; <label>:10:                                     ; preds = %1
  ...
  %14 = bitcast %class.FullNoteQueue* %5 to %class.NotifierQueue*
  call void @_ZN13NotifierQueueD2Ev(%class.NotifierQueue* %14) #7
  br label %15
...
; Function Attrs: noinline optnone uwtable
define i8* @_ZN13FullNoteQueue4castEPKc(%class.FullNoteQueue*, i8*) unnamed_addr #0 align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %class.FullNoteQueue*, align 8
  %5 = alloca i8*, align 8
  store %class.FullNoteQueue* %0, %class.FullNoteQueue** %4, align 8
  store i8* %1, i8** %5, align 8
  %6 = load %class.FullNoteQueue*, %class.FullNoteQueue** %4, align 8
...
; <label>:10:                                     ; preds = %2
  %11 = bitcast %class.FullNoteQueue* %6 to i8*
  store i8* %11, i8** %3, align 8
  br label %24

; <label>:12:                                     ; preds = %2
  %13 = load i8*, i8** %5, align 8
  %14 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN8Notifier13FULL_NOTIFIERE, i32 0, i32 0)) #8
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %20

; <label>:16:                                     ; preds = %12
  %17 = getelementptr inbounds %class.FullNoteQueue, %class.FullNoteQueue* %6, i32 0, i32 1
...
; <label>:20:                                     ; preds = %12
  %21 = bitcast %class.FullNoteQueue* %6 to %class.NotifierQueue*
  %22 = load i8*, i8** %5, align 8
  %23 = call i8* @_ZN13NotifierQueue4castEPKc(%class.NotifierQueue* %21, i8* %22)
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN13FullNoteQueue9configureER6VectorI6StringEP12ErrorHandler(%class.FullNoteQueue*, %class.Vector.7* nonnull, %class.ErrorHandler*) unnamed_addr #0 align 2 {
  %4 = alloca %class.FullNoteQueue*, align 8
  ...
  %7 = load %class.FullNoteQueue*, %class.FullNoteQueue** %4, align 8
  %8 = getelementptr inbounds %class.FullNoteQueue, %class.FullNoteQueue* %7, i32 0, i32 1
  %9 = bitcast %class.ActiveNotifier* %8 to %class.Notifier*
  %10 = bitcast %class.FullNoteQueue* %7 to %class.Element*
  %11 = call %class.Router* @_ZNK7Element6routerEv(%class.Element* %10)
  %12 = call i32 @_ZN8Notifier10initializeEPKcP6Router(%class.Notifier* %9, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN8Notifier13FULL_NOTIFIERE, i32 0, i32 0), %class.Router* %11)
  %13 = getelementptr inbounds %class.FullNoteQueue, %class.FullNoteQueue* %7, i32 0, i32 1
  call void @_ZN14ActiveNotifier10set_activeEbb(%class.ActiveNotifier* %13, i1 zeroext true, i1 zeroext false)
  %14 = bitcast %class.FullNoteQueue* %7 to %class.NotifierQueue*
  %15 = load %class.Vector.7*, %class.Vector.7** %5, align 8
  %16 = load %class.ErrorHandler*, %class.ErrorHandler** %6, align 8
  %17 = call i32 @_ZN13NotifierQueue9configureER6VectorI6StringEP12ErrorHandler(%class.NotifierQueue* %14, %class.Vector.7* nonnull %15, %class.ErrorHandler* %16)
  ret i32 %17
}
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN13FullNoteQueue16live_reconfigureER6VectorI6StringEP12ErrorHandler(%class.FullNoteQueue*, %class.Vector.7* nonnull, %class.ErrorHandler*) unnamed_addr #0 align 2 {
  %4 = alloca %class.FullNoteQueue*, align 8
  %5 = alloca %class.Vector.7*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  ...
  %9 = bitcast %class.FullNoteQueue* %8 to %class.NotifierQueue*
...
; <label>:16:                                     ; preds = %3
  %17 = bitcast %class.FullNoteQueue* %8 to i8*
  ...
  %21 = bitcast %class.FullNoteQueue* %8 to i8*
...
; <label>:26:                                     ; preds = %16
  %27 = bitcast %class.FullNoteQueue* %8 to %class.SimpleQueue*
...
; <label>:31:                                     ; preds = %26
  %32 = getelementptr inbounds %class.FullNoteQueue, %class.FullNoteQueue* %8, i32 0, i32 1
  call void @_ZN14ActiveNotifier4wakeEv(%class.ActiveNotifier* %32)
  br label %33

; <label>:33:                                     ; preds = %31, %26, %16, %3
...
; Function Attrs: noinline optnone uwtable
define void @_ZN13FullNoteQueue4pushEiP6Packet(%class.FullNoteQueue*, i32, %class.Packet*) unnamed_addr #0 align 2 {
  %4 = alloca %class.FullNoteQueue*, align 8
  ...
  %10 = load %class.FullNoteQueue*, %class.FullNoteQueue** %4, align 8
  %11 = bitcast %class.FullNoteQueue* %10 to i8*
  ...
  %15 = bitcast %class.FullNoteQueue* %10 to i8*
  %16 = getelementptr inbounds i8, i8* %15, i64 108
  %17 = bitcast i8* %16 to %class.Storage*
  %18 = call i32 @_ZNK7Storage4tailEv(%class.Storage* %17)
  store i32 %18, i32* %8, align 4
  %19 = bitcast %class.FullNoteQueue* %10 to i8*
  %20 = getelementptr inbounds i8, i8* %19, i64 108
  %21 = bitcast i8* %20 to %class.Storage*
  %22 = load i32, i32* %8, align 4
  %23 = call i32 @_ZNK7Storage6next_iEj(%class.Storage* %21, i32 %22)
...
; <label>:27:                                     ; preds = %3
  ...
  call void @_ZN13FullNoteQueue12push_successEjjjP6Packet(%class.FullNoteQueue* %10, i32 %28, i32 %29, i32 %30, %class.Packet* %31)
  br label %34

; <label>:32:                                     ; preds = %3
  %33 = load %class.Packet*, %class.Packet** %6, align 8
  call void @_ZN13FullNoteQueue12push_failureEP6Packet(%class.FullNoteQueue* %10, %class.Packet* %33)
  br label %34
...
; <label>:17:                                     ; preds = %10
  call void (i8*, ...) @click_chatter(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i32 0, i32 0), %class.FullNoteQueue* %5)
  br label %18
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN13FullNoteQueue4pullEi(%class.FullNoteQueue*, i32) unnamed_addr #0 align 2 {
  ...
  store %class.FullNoteQueue* %0, %class.FullNoteQueue** %4, align 8
  store i32 %1, i32* %5, align 4
  %9 = load %class.FullNoteQueue*, %class.FullNoteQueue** %4, align 8
  %10 = bitcast %class.FullNoteQueue* %9 to i8*
  %11 = getelementptr inbounds i8, i8* %10, i64 108
  %12 = bitcast i8* %11 to %class.Storage*
  %13 = call i32 @_ZNK7Storage4headEv(%class.Storage* %12)
  store i32 %13, i32* %6, align 4
  %14 = bitcast %class.FullNoteQueue* %9 to i8*
  %15 = getelementptr inbounds i8, i8* %14, i64 108
  %16 = bitcast i8* %15 to %class.Storage*
  %17 = call i32 @_ZNK7Storage4tailEv(%class.Storage* %16)
  store i32 %17, i32* %7, align 4
  %18 = bitcast %class.FullNoteQueue* %9 to i8*
  %19 = getelementptr inbounds i8, i8* %18, i64 108
  %20 = bitcast i8* %19 to %class.Storage*
  %21 = load i32, i32* %6, align 4
  %22 = call i32 @_ZNK7Storage6next_iEj(%class.Storage* %20, i32 %21)
...
; <label>:26:                                     ; preds = %2
  ...
  %29 = call %class.Packet* @_ZN13FullNoteQueue12pull_successEjj(%class.FullNoteQueue* %9, i32 %27, i32 %28)
  store %class.Packet* %29, %class.Packet** %3, align 8
  br label %32

; <label>:30:                                     ; preds = %2
  %31 = call %class.Packet* @_ZN13FullNoteQueue12pull_failureEv(%class.FullNoteQueue* %9)
  store %class.Packet* %31, %class.Packet** %3, align 8
  br label %32

; <label>:32:                                     ; preds = %30, %26
  %33 = load %class.Packet*, %class.Packet** %3, align 8
  ret %class.Packet* %33
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13FullNoteQueueD0Ev(%class.FullNoteQueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.FullNoteQueue*, align 8
  store %class.FullNoteQueue* %0, %class.FullNoteQueue** %2, align 8
  %3 = load %class.FullNoteQueue*, %class.FullNoteQueue** %2, align 8
  call void @_ZN13FullNoteQueueD2Ev(%class.FullNoteQueue* %3) #7
  %4 = bitcast %class.FullNoteQueue* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13FullNoteQueue10class_nameEv(%class.FullNoteQueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.FullNoteQueue*, align 8
  store %class.FullNoteQueue* %0, %class.FullNoteQueue** %2, align 8
  %3 = load %class.FullNoteQueue*, %class.FullNoteQueue** %2, align 8
...
; <label>:15:                                     ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i32 0, i32 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %17
