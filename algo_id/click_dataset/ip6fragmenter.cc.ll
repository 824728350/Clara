; ModuleID = '../../click/elements/ip6/ip6fragmenter.cc'
source_filename = "../../click/elements/ip6/ip6fragmenter.cc"
...
$_ZNK13IP6Fragmenter5dropsEv = comdat any

$_ZNK13IP6Fragmenter9fragmentsEv = comdat any
...
@_ZTV13IP6Fragmenter = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13IP6Fragmenter to i8*), i8* bitcast (void (%class.IP6Fragmenter*)* @_ZN13IP6FragmenterD1Ev to i8*), i8* bitcast (void (%class.IP6Fragmenter*)* @_ZN13IP6FragmenterD0Ev to i8*), i8* bitcast (void (%class.IP6Fragmenter*, i32, %class.Packet*)* @_ZN13IP6Fragmenter4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.IP6Fragmenter*)* @_ZNK13IP6Fragmenter10class_nameEv to i8*), i8* bitcast (i8* (%class.IP6Fragmenter*)* @_ZNK13IP6Fragmenter10port_countEv to i8*), i8* bitcast (i8* (%class.IP6Fragmenter*)* @_ZNK13IP6Fragmenter10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.IP6Fragmenter*, %class.Vector*, %class.ErrorHandler*)* @_ZN13IP6Fragmenter9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.IP6Fragmenter*)* @_ZN13IP6Fragmenter12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
...
@_ZTS13IP6Fragmenter = constant [16 x i8] c"13IP6Fragmenter\00"
@_ZTI7Element = external constant i8*
@_ZTI13IP6Fragmenter = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13IP6Fragmenter, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@_ZN13IP6FragmenterC1Ev = alias void (%class.IP6Fragmenter*), void (%class.IP6Fragmenter*)* @_ZN13IP6FragmenterC2Ev
@_ZN13IP6FragmenterD1Ev = alias void (%class.IP6Fragmenter*), void (%class.IP6Fragmenter*)* @_ZN13IP6FragmenterD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN13IP6FragmenterC2Ev(%class.IP6Fragmenter*) unnamed_addr #0 align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  %4 = bitcast %class.IP6Fragmenter* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.IP6Fragmenter* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13IP6Fragmenter, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  %6 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %3, i32 0, i32 2
  store i32 0, i32* %6, align 8
  %7 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %3, i32 0, i32 3
  store i32 0, i32* %7, align 4
  %8 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %3, i32 0, i32 1
...
define void @_ZN13IP6FragmenterD2Ev(%class.IP6Fragmenter*) unnamed_addr #2 align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  %4 = bitcast %class.IP6Fragmenter* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN13IP6FragmenterD0Ev(%class.IP6Fragmenter*) unnamed_addr #2 align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  call void @_ZN13IP6FragmenterD1Ev(%class.IP6Fragmenter* %3) #8
  %4 = bitcast %class.IP6Fragmenter* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN13IP6Fragmenter9configureER6VectorI6StringEP12ErrorHandler(%class.IP6Fragmenter*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.IP6Fragmenter*, align 8
  %5 = alloca %class.Vector*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %4, align 8
  store %class.Vector* %1, %class.Vector** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %4, align 8
  %11 = load %class.Vector*, %class.Vector** %5, align 8
  %12 = bitcast %class.IP6Fragmenter* %10 to %class.Element*
  ...
  %14 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %10, i32 0, i32 1
  %15 = invoke dereferenceable(112) %class.Args* @_ZN4Args7read_mpIjEERS_PKcRT_(%class.Args* %7, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32* dereferenceable(4) %14)
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN13IP6Fragmenter8fragmentEP6Packet(%class.IP6Fragmenter*, %class.Packet*) #2 align 2 {
  %3 = alloca %class.IP6Fragmenter*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %3, align 8
  ret void
}

; Function Attrs: noinline optnone uwtable
define void @_ZN13IP6Fragmenter12add_handlersEv(%class.IP6Fragmenter*) unnamed_addr #0 align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  %4 = bitcast %class.IP6Fragmenter* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %4, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZL24IP6Fragmenter_read_dropsP7ElementPv, i32 0, i32 0)
  %5 = bitcast %class.IP6Fragmenter* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %5, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZL28IP6Fragmenter_read_fragmentsP7ElementPv, i32 0, i32 0)
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define internal void @_ZL24IP6Fragmenter_read_dropsP7ElementPv(%class.String* noalias sret, %class.Element*, i8*) #0 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %class.IP6Fragmenter*, align 8
  store %class.Element* %1, %class.Element** %4, align 8
  store i8* %2, i8** %5, align 8
  %7 = load %class.Element*, %class.Element** %4, align 8
  %8 = bitcast %class.Element* %7 to %class.IP6Fragmenter*
  store %class.IP6Fragmenter* %8, %class.IP6Fragmenter** %6, align 8
  %9 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %6, align 8
  %10 = call i32 @_ZNK13IP6Fragmenter5dropsEv(%class.IP6Fragmenter* %9)
  call void @_ZN6StringC1Ei(%class.String* %0, i32 %10)
  ret void
}

; Function Attrs: noinline optnone uwtable
define internal void @_ZL28IP6Fragmenter_read_fragmentsP7ElementPv(%class.String* noalias sret, %class.Element*, i8*) #0 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %class.IP6Fragmenter*, align 8
  store %class.Element* %1, %class.Element** %4, align 8
  ...
  store %class.IP6Fragmenter* %8, %class.IP6Fragmenter** %6, align 8
  %9 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %6, align 8
  %10 = call i32 @_ZNK13IP6Fragmenter9fragmentsEv(%class.IP6Fragmenter* %9)
  call void @_ZN6StringC1Ei(%class.String* %0, i32 %10)
  ret void
}

; Function Attrs: noinline optnone uwtable
define void @_ZN13IP6Fragmenter4pushEiP6Packet(%class.IP6Fragmenter*, i32, %class.Packet*) unnamed_addr #0 align 2 {
  %4 = alloca %class.IP6Fragmenter*, align 8
  ...
  %7 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %4, align 8
  %8 = load %class.Packet*, %class.Packet** %6, align 8
  %9 = call i32 @_ZNK6Packet6lengthEv(%class.Packet* %8)
  %10 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %7, i32 0, i32 1
  %11 = load i32, i32* %10, align 4
  %12 = icmp ule i32 %9, %11
  br i1 %12, label %13, label %17

; <label>:13:                                     ; preds = %3
  %14 = bitcast %class.IP6Fragmenter* %7 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13IP6Fragmenter10class_nameEv(%class.IP6Fragmenter*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13IP6Fragmenter10port_countEv(%class.IP6Fragmenter*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13IP6Fragmenter10processingEv(%class.IP6Fragmenter*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i32 @_ZNK13IP6Fragmenter5dropsEv(%class.IP6Fragmenter*) #2 comdat align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  %4 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %3, i32 0, i32 2
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i32 @_ZNK13IP6Fragmenter9fragmentsEv(%class.IP6Fragmenter*) #2 comdat align 2 {
  %2 = alloca %class.IP6Fragmenter*, align 8
  store %class.IP6Fragmenter* %0, %class.IP6Fragmenter** %2, align 8
  %3 = load %class.IP6Fragmenter*, %class.IP6Fragmenter** %2, align 8
  %4 = getelementptr inbounds %class.IP6Fragmenter, %class.IP6Fragmenter* %3, i32 0, i32 3
