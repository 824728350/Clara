; ModuleID = '../../click/elements/ip/markipheader.cc'
source_filename = "../../click/elements/ip/markipheader.cc"
...
@_ZTV12MarkIPHeader = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI12MarkIPHeader to i8*), i8* bitcast (void (%class.MarkIPHeader*)* @_ZN12MarkIPHeaderD1Ev to i8*), i8* bitcast (void (%class.MarkIPHeader*)* @_ZN12MarkIPHeaderD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.MarkIPHeader*, %class.Packet*)* @_ZN12MarkIPHeader13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.MarkIPHeader*)* @_ZNK12MarkIPHeader10class_nameEv to i8*), i8* bitcast (i8* (%class.MarkIPHeader*)* @_ZNK12MarkIPHeader10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.MarkIPHeader*, %class.Vector*, %class.ErrorHandler*)* @_ZN12MarkIPHeader9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [7 x i8] c"OFFSET\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS12MarkIPHeader = constant [15 x i8] c"12MarkIPHeader\00"
@_ZTI7Element = external constant i8*
@_ZTI12MarkIPHeader = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @_ZTS12MarkIPHeader, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
@.str.1 = private unnamed_addr constant [41 x i8] c"p >= buffer() && p + len <= end_buffer()\00", align 1
...
@.str.3 = private unnamed_addr constant [13 x i8] c"MarkIPHeader\00", align 1
...
@_ZN12MarkIPHeaderC1Ev = alias void (%class.MarkIPHeader*), void (%class.MarkIPHeader*)* @_ZN12MarkIPHeaderC2Ev
@_ZN12MarkIPHeaderD1Ev = alias void (%class.MarkIPHeader*), void (%class.MarkIPHeader*)* @_ZN12MarkIPHeaderD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN12MarkIPHeaderC2Ev(%class.MarkIPHeader*) unnamed_addr #0 align 2 {
  %2 = alloca %class.MarkIPHeader*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %2, align 8
  %3 = load %class.MarkIPHeader*, %class.MarkIPHeader** %2, align 8
  %4 = bitcast %class.MarkIPHeader* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.MarkIPHeader* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12MarkIPHeader, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
...
define void @_ZN12MarkIPHeaderD2Ev(%class.MarkIPHeader*) unnamed_addr #2 align 2 {
  %2 = alloca %class.MarkIPHeader*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %2, align 8
  %3 = load %class.MarkIPHeader*, %class.MarkIPHeader** %2, align 8
  %4 = bitcast %class.MarkIPHeader* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN12MarkIPHeaderD0Ev(%class.MarkIPHeader*) unnamed_addr #2 align 2 {
  %2 = alloca %class.MarkIPHeader*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %2, align 8
  %3 = load %class.MarkIPHeader*, %class.MarkIPHeader** %2, align 8
  call void @_ZN12MarkIPHeaderD1Ev(%class.MarkIPHeader* %3) #8
  %4 = bitcast %class.MarkIPHeader* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12MarkIPHeader9configureER6VectorI6StringEP12ErrorHandler(%class.MarkIPHeader*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.MarkIPHeader*, align 8
  %5 = alloca %class.Vector*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %4, align 8
  store %class.Vector* %1, %class.Vector** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.MarkIPHeader*, %class.MarkIPHeader** %4, align 8
  %11 = getelementptr inbounds %class.MarkIPHeader, %class.MarkIPHeader* %10, i32 0, i32 1
  store i32 0, i32* %11, align 4
  %12 = load %class.Vector*, %class.Vector** %5, align 8
  %13 = bitcast %class.MarkIPHeader* %10 to %class.Element*
  ...
  %15 = getelementptr inbounds %class.MarkIPHeader, %class.MarkIPHeader* %10, i32 0, i32 1
  %16 = invoke dereferenceable(112) %class.Args* @_ZN4Args6read_pIiEERS_PKcRT_(%class.Args* %7, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32* dereferenceable(4) %15)
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN12MarkIPHeader13simple_actionEP6Packet(%class.MarkIPHeader*, %class.Packet*) unnamed_addr #0 align 2 {
  %3 = alloca %class.MarkIPHeader*, align 8
  %4 = alloca %class.Packet*, align 8
  %5 = alloca %struct.click_ip*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %6 = load %class.MarkIPHeader*, %class.MarkIPHeader** %3, align 8
  %7 = load %class.Packet*, %class.Packet** %4, align 8
  %8 = call i8* @_ZNK6Packet4dataEv(%class.Packet* %7)
  %9 = getelementptr inbounds %class.MarkIPHeader, %class.MarkIPHeader* %6, i32 0, i32 1
  %10 = load i32, i32* %9, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds i8, i8* %8, i64 %11
  %13 = bitcast i8* %12 to %struct.click_ip*
  store %struct.click_ip* %13, %struct.click_ip** %5, align 8
  %14 = load %class.Packet*, %class.Packet** %4, align 8
  %15 = load %struct.click_ip*, %struct.click_ip** %5, align 8
  ...
  %21 = shl i32 %20, 2
  call void @_ZN6Packet13set_ip_headerEPK8click_ipj(%class.Packet* %14, %struct.click_ip* %15, i32 %21)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12MarkIPHeader10class_nameEv(%class.MarkIPHeader*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.MarkIPHeader*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %2, align 8
  %3 = load %class.MarkIPHeader*, %class.MarkIPHeader** %2, align 8
  ret i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12MarkIPHeader10port_countEv(%class.MarkIPHeader*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.MarkIPHeader*, align 8
  store %class.MarkIPHeader* %0, %class.MarkIPHeader** %2, align 8
  %3 = load %class.MarkIPHeader*, %class.MarkIPHeader** %2, align 8
...
; <label>:21:                                     ; preds = %18
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i32 0, i32 0), i32 1858, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__PRETTY_FUNCTION__._ZN6Packet18set_network_headerEPKhj, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %23
