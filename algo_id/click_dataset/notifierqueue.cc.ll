; ModuleID = '../../click/elements/standard/notifierqueue.cc'
source_filename = "../../click/elements/standard/notifierqueue.cc"
...
@_ZTS13NotifierQueue = constant [16 x i8] c"13NotifierQueue\00"
@_ZTI11SimpleQueue = external constant i8*
@_ZTI13NotifierQueue = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13NotifierQueue, i32 0, i32 0), i8* bitcast (i8** @_ZTI11SimpleQueue to i8*) }
...
@.str.7 = private unnamed_addr constant [45 x i8] c"../../click/elements/standard/simplequeue.hh\00", align 1
...
@_ZN13NotifierQueueC1Ev = alias void (%class.NotifierQueue*), void (%class.NotifierQueue*)* @_ZN13NotifierQueueC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN13NotifierQueueC2Ev(%class.NotifierQueue*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.NotifierQueue*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.NotifierQueue* %0, %class.NotifierQueue** %2, align 8
  %5 = load %class.NotifierQueue*, %class.NotifierQueue** %2, align 8
  %6 = bitcast %class.NotifierQueue* %5 to %class.SimpleQueue*
  call void @_ZN11SimpleQueueC2Ev(%class.SimpleQueue* %6)
  %7 = bitcast %class.NotifierQueue* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13NotifierQueue, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %5, i32 0, i32 1
  store i32 0, i32* %8, align 8
  %9 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %5, i32 0, i32 2
  invoke void @_ZN14ActiveNotifierC1EN8Notifier8SearchOpE(%class.ActiveNotifier* %9, i32 0)
...
; <label>:11:                                     ; preds = %1
  ...
  %15 = bitcast %class.NotifierQueue* %5 to %class.SimpleQueue*
  call void @_ZN11SimpleQueueD2Ev(%class.SimpleQueue* %15) #7
  br label %16
...
declare void @_ZN11SimpleQueueC2Ev(%class.SimpleQueue*) unnamed_addr #1
...
; Function Attrs: noinline optnone uwtable
define i8* @_ZN13NotifierQueue4castEPKc(%class.NotifierQueue*, i8*) unnamed_addr #0 align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %class.NotifierQueue*, align 8
  %5 = alloca i8*, align 8
  store %class.NotifierQueue* %0, %class.NotifierQueue** %4, align 8
  store i8* %1, i8** %5, align 8
  %6 = load %class.NotifierQueue*, %class.NotifierQueue** %4, align 8
  %7 = load i8*, i8** %5, align 8
  %8 = call i32 @strcmp(i8* %7, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0)) #8
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %10, label %12

; <label>:10:                                     ; preds = %2
  %11 = bitcast %class.NotifierQueue* %6 to i8*
  store i8* %11, i8** %3, align 8
  br label %24

; <label>:12:                                     ; preds = %2
  %13 = load i8*, i8** %5, align 8
  %14 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN8Notifier14EMPTY_NOTIFIERE, i32 0, i32 0)) #8
  %15 = icmp eq i32 %14, 0
  br i1 %15, label %16, label %20

; <label>:16:                                     ; preds = %12
  %17 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %6, i32 0, i32 2
  %18 = bitcast %class.ActiveNotifier* %17 to %class.Notifier*
  %19 = bitcast %class.Notifier* %18 to i8*
  store i8* %19, i8** %3, align 8
  br label %24

; <label>:20:                                     ; preds = %12
  %21 = bitcast %class.NotifierQueue* %6 to %class.SimpleQueue*
  %22 = load i8*, i8** %5, align 8
  %23 = call i8* @_ZN11SimpleQueue4castEPKc(%class.SimpleQueue* %21, i8* %22)
  store i8* %23, i8** %3, align 8
  br label %24

; <label>:24:                                     ; preds = %20, %16, %10
...
declare i8* @_ZN11SimpleQueue4castEPKc(%class.SimpleQueue*, i8*) unnamed_addr #1

; Function Attrs: noinline optnone uwtable
define i32 @_ZN13NotifierQueue9configureER6VectorI6StringEP12ErrorHandler(%class.NotifierQueue*, %class.Vector.7* nonnull, %class.ErrorHandler*) unnamed_addr #0 align 2 {
  %4 = alloca %class.NotifierQueue*, align 8
  ...
  %7 = load %class.NotifierQueue*, %class.NotifierQueue** %4, align 8
  %8 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %7, i32 0, i32 2
  %9 = bitcast %class.ActiveNotifier* %8 to %class.Notifier*
  %10 = bitcast %class.NotifierQueue* %7 to %class.Element*
  %11 = call %class.Router* @_ZNK7Element6routerEv(%class.Element* %10)
  %12 = call i32 @_ZN8Notifier10initializeEPKcP6Router(%class.Notifier* %9, i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN8Notifier14EMPTY_NOTIFIERE, i32 0, i32 0), %class.Router* %11)
  %13 = bitcast %class.NotifierQueue* %7 to %class.SimpleQueue*
  %14 = load %class.Vector.7*, %class.Vector.7** %5, align 8
  %15 = load %class.ErrorHandler*, %class.ErrorHandler** %6, align 8
  %16 = call i32 @_ZN11SimpleQueue9configureER6VectorI6StringEP12ErrorHandler(%class.SimpleQueue* %13, %class.Vector.7* nonnull %14, %class.ErrorHandler* %15)
  ret i32 %16
}
...
declare i32 @_ZN11SimpleQueue9configureER6VectorI6StringEP12ErrorHandler(%class.SimpleQueue*, %class.Vector.7* nonnull, %class.ErrorHandler*) unnamed_addr #1

; Function Attrs: noinline optnone uwtable
define void @_ZN13NotifierQueue4pushEiP6Packet(%class.NotifierQueue*, i32, %class.Packet*) unnamed_addr #0 align 2 {
  %4 = alloca %class.NotifierQueue*, align 8
  ...
  %11 = load %class.NotifierQueue*, %class.NotifierQueue** %4, align 8
  %12 = bitcast %class.NotifierQueue* %11 to i8*
  ...
  %16 = bitcast %class.NotifierQueue* %11 to i8*
  ...
  %20 = bitcast %class.NotifierQueue* %11 to i8*
...
; <label>:28:                                     ; preds = %3
  ...
  %30 = bitcast %class.NotifierQueue* %11 to %class.SimpleQueue*
  %31 = getelementptr inbounds %class.SimpleQueue, %class.SimpleQueue* %30, i32 0, i32 2
  %32 = load %class.Packet**, %class.Packet*** %31, align 8
  %33 = load i32, i32* %8, align 4
  %34 = sext i32 %33 to i64
  %35 = getelementptr inbounds %class.Packet*, %class.Packet** %32, i64 %34
  store volatile %class.Packet* %29, %class.Packet** %35, align 8
  %36 = bitcast %class.NotifierQueue* %11 to i8*
  %37 = getelementptr inbounds i8, i8* %36, i64 108
  %38 = bitcast i8* %37 to %class.Storage*
  %39 = load i32, i32* %9, align 4
  call void @_ZN7Storage8set_tailEj(%class.Storage* %38, i32 %39)
  %40 = bitcast %class.NotifierQueue* %11 to i8*
  %41 = getelementptr inbounds i8, i8* %40, i64 108
  %42 = bitcast i8* %41 to %class.Storage*
  %43 = load i32, i32* %7, align 4
  %44 = load i32, i32* %9, align 4
  %45 = call i32 @_ZNK7Storage4sizeEjj(%class.Storage* %42, i32 %43, i32 %44)
  store i32 %45, i32* %10, align 4
  %46 = load i32, i32* %10, align 4
  %47 = bitcast %class.NotifierQueue* %11 to %class.SimpleQueue*
  %48 = getelementptr inbounds %class.SimpleQueue, %class.SimpleQueue* %47, i32 0, i32 4
...
; <label>:51:                                     ; preds = %28
  ...
  %53 = bitcast %class.NotifierQueue* %11 to %class.SimpleQueue*
  %54 = getelementptr inbounds %class.SimpleQueue, %class.SimpleQueue* %53, i32 0, i32 4
  store i32 %52, i32* %54, align 4
  br label %55

; <label>:55:                                     ; preds = %51, %28
  %56 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %11, i32 0, i32 2
  call void @_ZN14ActiveNotifier4wakeEv(%class.ActiveNotifier* %56)
  br label %77

; <label>:57:                                     ; preds = %3
  %58 = bitcast %class.NotifierQueue* %11 to %class.SimpleQueue*
  %59 = getelementptr inbounds %class.SimpleQueue, %class.SimpleQueue* %58, i32 0, i32 3
  %60 = load volatile i32, i32* %59, align 8
  %61 = icmp eq i32 %60, 0
  br i1 %61, label %62, label %70

; <label>:62:                                     ; preds = %57
  %63 = bitcast %class.NotifierQueue* %11 to i8*
  %64 = getelementptr inbounds i8, i8* %63, i64 108
  %65 = bitcast i8* %64 to %class.Storage*
  %66 = getelementptr inbounds %class.Storage, %class.Storage* %65, i32 0, i32 0
  %67 = load i32, i32* %66, align 4
  %68 = icmp ugt i32 %67, 0
  br i1 %68, label %69, label %70

; <label>:69:                                     ; preds = %62
  call void (i8*, ...) @click_chatter(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), %class.NotifierQueue* %11)
  br label %70

; <label>:70:                                     ; preds = %69, %62, %57
  %71 = bitcast %class.NotifierQueue* %11 to %class.SimpleQueue*
  %72 = getelementptr inbounds %class.SimpleQueue, %class.SimpleQueue* %71, i32 0, i32 3
  %73 = load volatile i32, i32* %72, align 8
  %74 = add nsw i32 %73, 1
  store volatile i32 %74, i32* %72, align 8
  %75 = bitcast %class.NotifierQueue* %11 to %class.Element*
  %76 = load %class.Packet*, %class.Packet** %6, align 8
  call void @_ZNK7Element19checked_output_pushEiP6Packet(%class.Element* %75, i32 1, %class.Packet* %76)
  br label %77
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN13NotifierQueue4pullEi(%class.NotifierQueue*, i32) unnamed_addr #0 align 2 {
  %3 = alloca %class.NotifierQueue*, align 8
  %4 = alloca i32, align 4
  %5 = alloca %class.Packet*, align 8
  store %class.NotifierQueue* %0, %class.NotifierQueue** %3, align 8
  store i32 %1, i32* %4, align 4
  %6 = load %class.NotifierQueue*, %class.NotifierQueue** %3, align 8
  %7 = bitcast %class.NotifierQueue* %6 to %class.SimpleQueue*
  %8 = call %class.Packet* @_ZN11SimpleQueue3deqEv(%class.SimpleQueue* %7)
  store %class.Packet* %8, %class.Packet** %5, align 8
  %9 = load %class.Packet*, %class.Packet** %5, align 8
  %10 = icmp ne %class.Packet* %9, null
  br i1 %10, label %11, label %13

; <label>:11:                                     ; preds = %2
  %12 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %6, i32 0, i32 1
  store i32 0, i32* %12, align 8
  br label %24

; <label>:13:                                     ; preds = %2
  %14 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %6, i32 0, i32 1
  %15 = load i32, i32* %14, align 8
  %16 = icmp sge i32 %15, 9
  br i1 %16, label %17, label %19

; <label>:17:                                     ; preds = %13
  %18 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %6, i32 0, i32 2
  call void @_ZN14ActiveNotifier5sleepEv(%class.ActiveNotifier* %18)
  br label %23

; <label>:19:                                     ; preds = %13
  %20 = getelementptr inbounds %class.NotifierQueue, %class.NotifierQueue* %6, i32 0, i32 1
...
; <label>:37:                                     ; preds = %19
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.7, i32 0, i32 0), i32 159, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__PRETTY_FUNCTION__._ZN11SimpleQueue3deqEv, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %39
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13NotifierQueueD0Ev(%class.NotifierQueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.NotifierQueue*, align 8
  store %class.NotifierQueue* %0, %class.NotifierQueue** %2, align 8
  %3 = load %class.NotifierQueue*, %class.NotifierQueue** %2, align 8
  call void @_ZN13NotifierQueueD2Ev(%class.NotifierQueue* %3) #7
  %4 = bitcast %class.NotifierQueue* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13NotifierQueue10class_nameEv(%class.NotifierQueue*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.NotifierQueue*, align 8
  store %class.NotifierQueue* %0, %class.NotifierQueue** %2, align 8
  %3 = load %class.NotifierQueue*, %class.NotifierQueue** %2, align 8
...
; <label>:24:                                     ; preds = %21
  call void @__assert_fail(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.3, i32 0, i32 0), i32 293, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__PRETTY_FUNCTION__._ZN14NotifierSignal10set_activeEb, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %26
...
; <label>:15:                                     ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i32 0, i32 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %17
