; ModuleID = '../../click/elements/standard/paint.cc'
source_filename = "../../click/elements/standard/paint.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.Paint = type { %class.Element.base, i8, i8, [2 x i8] }
...
$_ZN5PaintD2Ev = comdat any

$_ZN5PaintD0Ev = comdat any

$_ZNK5Paint10class_nameEv = comdat any

$_ZNK5Paint10port_countEv = comdat any

$_ZNK5Paint20can_live_reconfigureEv = comdat any
...
@_ZTV5Paint = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI5Paint to i8*), i8* bitcast (void (%class.Paint*)* @_ZN5PaintD2Ev to i8*), i8* bitcast (void (%class.Paint*)* @_ZN5PaintD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Paint*, %class.Packet*)* @_ZN5Paint13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.Paint*)* @_ZNK5Paint10class_nameEv to i8*), i8* bitcast (i8* (%class.Paint*)* @_ZNK5Paint10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Paint*, %class.Vector*, %class.ErrorHandler*)* @_ZN5Paint9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Paint*)* @_ZN5Paint12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Paint*)* @_ZNK5Paint20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
...
@_ZTS5Paint = constant [7 x i8] c"5Paint\00"
@_ZTI7Element = external constant i8*
@_ZTI5Paint = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @_ZTS5Paint, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.5 = private unnamed_addr constant [6 x i8] c"Paint\00", align 1
...
@_ZN5PaintC1Ev = alias void (%class.Paint*), void (%class.Paint*)* @_ZN5PaintC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN5PaintC2Ev(%class.Paint*) unnamed_addr #0 align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  %4 = bitcast %class.Paint* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.Paint* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV5Paint, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN5Paint9configureER6VectorI6StringEP12ErrorHandler(%class.Paint*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca i32, align 4
  %5 = alloca %class.Paint*, align 8
  ...
  store %class.Paint* %0, %class.Paint** %5, align 8
  store %class.Vector* %1, %class.Vector** %6, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %7, align 8
  %13 = load %class.Paint*, %class.Paint** %5, align 8
  store i32 16, i32* %8, align 4
  %14 = load %class.Vector*, %class.Vector** %6, align 8
  %15 = bitcast %class.Paint* %13 to %class.Element*
  ...
  %17 = getelementptr inbounds %class.Paint, %class.Paint* %13, i32 0, i32 2
...
; <label>:33:                                     ; preds = %26
  ...
  %36 = getelementptr inbounds %class.Paint, %class.Paint* %13, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN5Paint13simple_actionEP6Packet(%class.Paint*, %class.Packet*) unnamed_addr #0 align 2 {
  %3 = alloca %class.Paint*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.Paint* %0, %class.Paint** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.Paint*, %class.Paint** %3, align 8
  %6 = load %class.Packet*, %class.Packet** %4, align 8
  %7 = getelementptr inbounds %class.Paint, %class.Paint* %5, i32 0, i32 1
  %8 = load i8, i8* %7, align 4
  %9 = zext i8 %8 to i32
  %10 = getelementptr inbounds %class.Paint, %class.Paint* %5, i32 0, i32 2
  %11 = load i8, i8* %10, align 1
  call void @_ZN6Packet11set_anno_u8Eih(%class.Packet* %6, i32 %9, i8 zeroext %11)
...
; Function Attrs: noinline optnone uwtable
define void @_ZN5Paint12add_handlersEv(%class.Paint*) unnamed_addr #0 align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  %4 = bitcast %class.Paint* %3 to %class.Element*
  %5 = getelementptr inbounds %class.Paint, %class.Paint* %3, i32 0, i32 2
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN5PaintD2Ev(%class.Paint*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  %4 = bitcast %class.Paint* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN5PaintD0Ev(%class.Paint*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  call void @_ZN5PaintD2Ev(%class.Paint* %3) #8
  %4 = bitcast %class.Paint* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK5Paint10class_nameEv(%class.Paint*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  ret i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK5Paint10port_countEv(%class.Paint*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr zeroext i1 @_ZNK5Paint20can_live_reconfigureEv(%class.Paint*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Paint*, align 8
  store %class.Paint* %0, %class.Paint** %2, align 8
  %3 = load %class.Paint*, %class.Paint** %2, align 8
  ret i1 true
