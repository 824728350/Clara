; ModuleID = '../../click/elements/standard/priosched.cc'
source_filename = "../../click/elements/standard/priosched.cc"
...
@_ZTV9PrioSched = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI9PrioSched to i8*), i8* bitcast (void (%class.PrioSched*)* @_ZN9PrioSchedD2Ev to i8*), i8* bitcast (void (%class.PrioSched*)* @_ZN9PrioSchedD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.PrioSched*, i32)* @_ZN9PrioSched4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.PrioSched*)* @_ZNK9PrioSched10class_nameEv to i8*), i8* bitcast (i8* (%class.PrioSched*)* @_ZNK9PrioSched10port_countEv to i8*), i8* bitcast (i8* (%class.PrioSched*)* @_ZNK9PrioSched10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.PrioSched*)* @_ZNK9PrioSched5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.7*, %class.ErrorHandler*)* @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.PrioSched*, %class.ErrorHandler*)* @_ZN9PrioSched10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.PrioSched*, i32)* @_ZN9PrioSched7cleanupEN7Element12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.7*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [15 x i8] c"out of memory!\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS9PrioSched = constant [11 x i8] c"9PrioSched\00"
@_ZTI7Element = external constant i8*
@_ZTI9PrioSched = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_ZTS9PrioSched, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@_ZN9PrioSchedC1Ev = alias void (%class.PrioSched*), void (%class.PrioSched*)* @_ZN9PrioSchedC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN9PrioSchedC2Ev(%class.PrioSched*) unnamed_addr #0 align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
  %4 = bitcast %class.PrioSched* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.PrioSched* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV9PrioSched, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  %6 = getelementptr inbounds %class.PrioSched, %class.PrioSched* %3, i32 0, i32 1
  store %class.NotifierSignal* null, %class.NotifierSignal** %6, align 8
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN9PrioSched10initializeEP12ErrorHandler(%class.PrioSched*, %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca i32, align 4
  %4 = alloca %class.PrioSched*, align 8
  %5 = alloca %class.ErrorHandler*, align 8
  %6 = alloca i8*
  %7 = alloca i32
  %8 = alloca i32, align 4
  %9 = alloca %class.NotifierSignal, align 8
  store %class.PrioSched* %0, %class.PrioSched** %4, align 8
  store %class.ErrorHandler* %1, %class.ErrorHandler** %5, align 8
  %10 = load %class.PrioSched*, %class.PrioSched** %4, align 8
  %11 = bitcast %class.PrioSched* %10 to %class.Element*
...
; <label>:34:                                     ; preds = %2, %31
  %35 = getelementptr inbounds %class.PrioSched, %class.PrioSched* %10, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN9PrioSched7cleanupEN7Element12CleanupStageE(%class.PrioSched*, i32) unnamed_addr #2 align 2 {
  %3 = alloca %class.PrioSched*, align 8
  %4 = alloca i32, align 4
  store %class.PrioSched* %0, %class.PrioSched** %3, align 8
  store i32 %1, i32* %4, align 4
  %5 = load %class.PrioSched*, %class.PrioSched** %3, align 8
  %6 = getelementptr inbounds %class.PrioSched, %class.PrioSched* %5, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN9PrioSched4pullEi(%class.PrioSched*, i32) unnamed_addr #0 align 2 {
  ...
  %8 = load %class.PrioSched*, %class.PrioSched** %4, align 8
  store i32 0, i32* %7, align 4
  br label %9

; <label>:9:                                      ; preds = %32, %2
  %10 = load i32, i32* %7, align 4
  %11 = bitcast %class.PrioSched* %8 to %class.Element*
  %12 = call i32 @_ZNK7Element7ninputsEv(%class.Element* %11)
  %13 = icmp slt i32 %10, %12
  br i1 %13, label %14, label %35

; <label>:14:                                     ; preds = %9
  %15 = getelementptr inbounds %class.PrioSched, %class.PrioSched* %8, i32 0, i32 1
  %16 = load %class.NotifierSignal*, %class.NotifierSignal** %15, align 8
  %17 = load i32, i32* %7, align 4
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %16, i64 %18
  %20 = call { i64, i64 } @_ZNK14NotifierSignalcvMS_KFbvEEv(%class.NotifierSignal* %19)
  %21 = extractvalue { i64, i64 } %20, 0
  %22 = icmp ne i64 %21, 0
  br i1 %22, label %23, label %31

; <label>:23:                                     ; preds = %14
  %24 = bitcast %class.PrioSched* %8 to %class.Element*
  %25 = load i32, i32* %7, align 4
  %26 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element5inputEi(%class.Element* %24, i32 %25)
  %27 = call %class.Packet* @_ZNK7Element4Port4pullEv(%"class.Element::Port"* %26)
  store %class.Packet* %27, %class.Packet** %6, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9PrioSchedD2Ev(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
  %4 = bitcast %class.PrioSched* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9PrioSchedD0Ev(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
  call void @_ZN9PrioSchedD2Ev(%class.PrioSched* %3) #9
  %4 = bitcast %class.PrioSched* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9PrioSched10class_nameEv(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9PrioSched10port_countEv(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9PrioSched10processingEv(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9PrioSched5flagsEv(%class.PrioSched*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.PrioSched*, align 8
  store %class.PrioSched* %0, %class.PrioSched** %2, align 8
  %3 = load %class.PrioSched*, %class.PrioSched** %2, align 8
