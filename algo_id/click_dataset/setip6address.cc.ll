; ModuleID = '../../click/elements/ip6/setip6address.cc'
source_filename = "../../click/elements/ip6/setip6address.cc"
...
@_ZTV13SetIP6Address = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13SetIP6Address to i8*), i8* bitcast (void (%class.SetIP6Address*)* @_ZN13SetIP6AddressD1Ev to i8*), i8* bitcast (void (%class.SetIP6Address*)* @_ZN13SetIP6AddressD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.SetIP6Address*, %class.Packet*)* @_ZN13SetIP6Address13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.SetIP6Address*)* @_ZNK13SetIP6Address10class_nameEv to i8*), i8* bitcast (i8* (%class.SetIP6Address*)* @_ZNK13SetIP6Address10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.SetIP6Address*, %class.Vector*, %class.ErrorHandler*)* @_ZN13SetIP6Address9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [7 x i8] c"IPADDR\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS13SetIP6Address = constant [16 x i8] c"13SetIP6Address\00"
@_ZTI7Element = external constant i8*
@_ZTI13SetIP6Address = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13SetIP6Address, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@_ZN13SetIP6AddressC1Ev = alias void (%class.SetIP6Address*), void (%class.SetIP6Address*)* @_ZN13SetIP6AddressC2Ev
@_ZN13SetIP6AddressD1Ev = alias void (%class.SetIP6Address*), void (%class.SetIP6Address*)* @_ZN13SetIP6AddressD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN13SetIP6AddressC2Ev(%class.SetIP6Address*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.SetIP6Address*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.SetIP6Address* %0, %class.SetIP6Address** %2, align 8
  %5 = load %class.SetIP6Address*, %class.SetIP6Address** %2, align 8
  %6 = bitcast %class.SetIP6Address* %5 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %6)
  %7 = bitcast %class.SetIP6Address* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV13SetIP6Address, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.SetIP6Address, %class.SetIP6Address* %5, i32 0, i32 1
...
; <label>:10:                                     ; preds = %1
  ...
  %14 = bitcast %class.SetIP6Address* %5 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN13SetIP6AddressD2Ev(%class.SetIP6Address*) unnamed_addr #2 align 2 {
  %2 = alloca %class.SetIP6Address*, align 8
  store %class.SetIP6Address* %0, %class.SetIP6Address** %2, align 8
  %3 = load %class.SetIP6Address*, %class.SetIP6Address** %2, align 8
  %4 = bitcast %class.SetIP6Address* %3 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %4) #8
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN13SetIP6AddressD0Ev(%class.SetIP6Address*) unnamed_addr #2 align 2 {
  %2 = alloca %class.SetIP6Address*, align 8
  store %class.SetIP6Address* %0, %class.SetIP6Address** %2, align 8
  %3 = load %class.SetIP6Address*, %class.SetIP6Address** %2, align 8
  call void @_ZN13SetIP6AddressD1Ev(%class.SetIP6Address* %3) #8
  %4 = bitcast %class.SetIP6Address* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN13SetIP6Address9configureER6VectorI6StringEP12ErrorHandler(%class.SetIP6Address*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.SetIP6Address*, align 8
  %5 = alloca %class.Vector*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.SetIP6Address* %0, %class.SetIP6Address** %4, align 8
  store %class.Vector* %1, %class.Vector** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.SetIP6Address*, %class.SetIP6Address** %4, align 8
  %11 = load %class.Vector*, %class.Vector** %5, align 8
  %12 = bitcast %class.SetIP6Address* %10 to %class.Element*
  ...
  %14 = getelementptr inbounds %class.SetIP6Address, %class.SetIP6Address* %10, i32 0, i32 1
  %15 = invoke dereferenceable(112) %class.Args* @_ZN4Args7read_mpI10IP6AddressEERS_PKcRT_(%class.Args* %7, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), %class.IP6Address* dereferenceable(16) %14)
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN13SetIP6Address13simple_actionEP6Packet(%class.SetIP6Address*, %class.Packet*) unnamed_addr #0 align 2 {
  %3 = alloca %class.SetIP6Address*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.SetIP6Address* %0, %class.SetIP6Address** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.SetIP6Address*, %class.SetIP6Address** %3, align 8
  %6 = load %class.Packet*, %class.Packet** %4, align 8
  %7 = getelementptr inbounds %class.SetIP6Address, %class.SetIP6Address* %5, i32 0, i32 1
  call void @_Z16SET_DST_IP6_ANNOP6PacketRK10IP6Address(%class.Packet* %6, %class.IP6Address* dereferenceable(16) %7)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13SetIP6Address10class_nameEv(%class.SetIP6Address*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.SetIP6Address*, align 8
  store %class.SetIP6Address* %0, %class.SetIP6Address** %2, align 8
  %3 = load %class.SetIP6Address*, %class.SetIP6Address** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK13SetIP6Address10port_countEv(%class.SetIP6Address*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.SetIP6Address*, align 8
  store %class.SetIP6Address* %0, %class.SetIP6Address** %2, align 8
  %3 = load %class.SetIP6Address*, %class.SetIP6Address** %2, align 8
