; ModuleID = '../../click/elements/threads/spinlockacquire.cc'
source_filename = "../../click/elements/threads/spinlockacquire.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.SpinlockAcquire = type { %class.Element.base, %class.Spinlock* }
...
$_ZN15SpinlockAcquireD2Ev = comdat any

$_ZN15SpinlockAcquireD0Ev = comdat any

$_ZN15SpinlockAcquire13simple_actionEP6Packet = comdat any

$_ZNK15SpinlockAcquire10class_nameEv = comdat any

$_ZNK15SpinlockAcquire10port_countEv = comdat any
...
@_ZTV15SpinlockAcquire = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI15SpinlockAcquire to i8*), i8* bitcast (void (%class.SpinlockAcquire*)* @_ZN15SpinlockAcquireD2Ev to i8*), i8* bitcast (void (%class.SpinlockAcquire*)* @_ZN15SpinlockAcquireD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.SpinlockAcquire*, %class.Packet*)* @_ZN15SpinlockAcquire13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.SpinlockAcquire*)* @_ZNK15SpinlockAcquire10class_nameEv to i8*), i8* bitcast (i8* (%class.SpinlockAcquire*)* @_ZNK15SpinlockAcquire10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.SpinlockAcquire*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN15SpinlockAcquire9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS15SpinlockAcquire = constant [18 x i8] c"15SpinlockAcquire\00"
@_ZTI7Element = external constant i8*
@_ZTI15SpinlockAcquire = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @_ZTS15SpinlockAcquire, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.4 = private unnamed_addr constant [16 x i8] c"SpinlockAcquire\00", align 1
...
define i32 @_ZN15SpinlockAcquire9configureER6VectorI6StringEP12ErrorHandler(%class.SpinlockAcquire*, %class.Vector.0* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca i32, align 4
  %5 = alloca %class.SpinlockAcquire*, align 8
  ...
  %11 = alloca i32
  %12 = alloca i32
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %5, align 8
  store %class.Vector.0* %1, %class.Vector.0** %6, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %7, align 8
  %13 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %5, align 8
  call void @_ZN6StringC2Ev(%class.String* %8)
  %14 = load %class.Vector.0*, %class.Vector.0** %6, align 8
  %15 = bitcast %class.SpinlockAcquire* %13 to %class.Element*
...
; <label>:32:                                     ; preds = %21
  %33 = bitcast %class.SpinlockAcquire* %13 to %class.Element*
  %34 = getelementptr inbounds %class.SpinlockAcquire, %class.SpinlockAcquire* %13, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN15SpinlockAcquireD2Ev(%class.SpinlockAcquire*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.SpinlockAcquire*, align 8
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %2, align 8
  %3 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %2, align 8
  %4 = bitcast %class.SpinlockAcquire* %3 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %4) #9
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN15SpinlockAcquireD0Ev(%class.SpinlockAcquire*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.SpinlockAcquire*, align 8
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %2, align 8
  %3 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %2, align 8
  call void @_ZN15SpinlockAcquireD2Ev(%class.SpinlockAcquire* %3) #9
  %4 = bitcast %class.SpinlockAcquire* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr %class.Packet* @_ZN15SpinlockAcquire13simple_actionEP6Packet(%class.SpinlockAcquire*, %class.Packet*) unnamed_addr #0 comdat align 2 {
  %3 = alloca %class.SpinlockAcquire*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %3, align 8
  %6 = getelementptr inbounds %class.SpinlockAcquire, %class.SpinlockAcquire* %5, i32 0, i32 1
  %7 = load %class.Spinlock*, %class.Spinlock** %6, align 8
  call void @_ZN8Spinlock7acquireEv(%class.Spinlock* %7)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK15SpinlockAcquire10class_nameEv(%class.SpinlockAcquire*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.SpinlockAcquire*, align 8
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %2, align 8
  %3 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK15SpinlockAcquire10port_countEv(%class.SpinlockAcquire*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.SpinlockAcquire*, align 8
  store %class.SpinlockAcquire* %0, %class.SpinlockAcquire** %2, align 8
  %3 = load %class.SpinlockAcquire*, %class.SpinlockAcquire** %2, align 8
...
; <label>:31:                                     ; preds = %13
  ...
  call void (%class.ArgContext*, i8*, ...) @_ZNK10ArgContext5errorEPKcz(%class.ArgContext* %32, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i32 0, i32 0))
