; ModuleID = '../../click/elements/standard/strip.cc'
source_filename = "../../click/elements/standard/strip.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.Strip = type { %class.Element.base, i32 }
...
$_ZN5StripD2Ev = comdat any

$_ZN5StripD0Ev = comdat any

$_ZNK5Strip10class_nameEv = comdat any

$_ZNK5Strip10port_countEv = comdat any
...
@_ZTV5Strip = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI5Strip to i8*), i8* bitcast (void (%class.Strip*)* @_ZN5StripD2Ev to i8*), i8* bitcast (void (%class.Strip*)* @_ZN5StripD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Strip*, %class.Packet*)* @_ZN5Strip13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.Strip*)* @_ZNK5Strip10class_nameEv to i8*), i8* bitcast (i8* (%class.Strip*)* @_ZNK5Strip10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Strip*, %class.Vector*, %class.ErrorHandler*)* @_ZN5Strip9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@.str = private unnamed_addr constant [7 x i8] c"LENGTH\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS5Strip = constant [7 x i8] c"5Strip\00"
@_ZTI7Element = external constant i8*
@_ZTI5Strip = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @_ZTS5Strip, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
@.str.1 = private unnamed_addr constant [29 x i8] c"Packet::pull %d > length %d\0A\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"Strip\00", align 1
...
@_ZN5StripC1Ev = alias void (%class.Strip*), void (%class.Strip*)* @_ZN5StripC2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN5StripC2Ev(%class.Strip*) unnamed_addr #0 align 2 {
  %2 = alloca %class.Strip*, align 8
  store %class.Strip* %0, %class.Strip** %2, align 8
  %3 = load %class.Strip*, %class.Strip** %2, align 8
  %4 = bitcast %class.Strip* %3 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %4)
  %5 = bitcast %class.Strip* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV5Strip, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %5, align 8
  ret void
}
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN5Strip9configureER6VectorI6StringEP12ErrorHandler(%class.Strip*, %class.Vector* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.Strip*, align 8
  %5 = alloca %class.Vector*, align 8
  %6 = alloca %class.ErrorHandler*, align 8
  %7 = alloca %class.Args, align 8
  %8 = alloca i8*
  %9 = alloca i32
  store %class.Strip* %0, %class.Strip** %4, align 8
  store %class.Vector* %1, %class.Vector** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %10 = load %class.Strip*, %class.Strip** %4, align 8
  %11 = load %class.Vector*, %class.Vector** %5, align 8
  %12 = bitcast %class.Strip* %10 to %class.Element*
  ...
  %14 = getelementptr inbounds %class.Strip, %class.Strip* %10, i32 0, i32 1
...
; Function Attrs: noinline optnone uwtable
define %class.Packet* @_ZN5Strip13simple_actionEP6Packet(%class.Strip*, %class.Packet*) unnamed_addr #0 align 2 {
  %3 = alloca %class.Strip*, align 8
  %4 = alloca %class.Packet*, align 8
  store %class.Strip* %0, %class.Strip** %3, align 8
  store %class.Packet* %1, %class.Packet** %4, align 8
  %5 = load %class.Strip*, %class.Strip** %3, align 8
  %6 = load %class.Packet*, %class.Packet** %4, align 8
  %7 = getelementptr inbounds %class.Strip, %class.Strip* %5, i32 0, i32 1
  %8 = load i32, i32* %7, align 4
  call void @_ZN6Packet4pullEj(%class.Packet* %6, i32 %8)
...
define linkonce_odr void @_ZN5StripD2Ev(%class.Strip*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.Strip*, align 8
  store %class.Strip* %0, %class.Strip** %2, align 8
  %3 = load %class.Strip*, %class.Strip** %2, align 8
  %4 = bitcast %class.Strip* %3 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN5StripD0Ev(%class.Strip*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.Strip*, align 8
  store %class.Strip* %0, %class.Strip** %2, align 8
  %3 = load %class.Strip*, %class.Strip** %2, align 8
  call void @_ZN5StripD2Ev(%class.Strip* %3) #8
  %4 = bitcast %class.Strip* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK5Strip10class_nameEv(%class.Strip*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.Strip*, align 8
  store %class.Strip* %0, %class.Strip** %2, align 8
  %3 = load %class.Strip*, %class.Strip** %2, align 8
  ret i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK5Strip10port_countEv(%class.Strip*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.Strip*, align 8
  store %class.Strip* %0, %class.Strip** %2, align 8
  %3 = load %class.Strip*, %class.Strip** %2, align 8
...
; <label>:33:                                     ; preds = %29
  ...
  call void (%class.ArgContext*, i8*, ...) @_ZNK10ArgContext5errorEPKcz(%class.ArgContext* %34, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0))
  store i1 false, i1* %5, align 1
  br label %38
