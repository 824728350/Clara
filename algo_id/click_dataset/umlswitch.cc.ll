; ModuleID = '../../click/elements/userlevel/umlswitch.cc'
source_filename = "../../click/elements/userlevel/umlswitch.cc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.UMLSwitch = type { %class.Socket, %struct.sockaddr_un, %struct.sockaddr_un, %struct.sockaddr_un, %class.String, i32, i32 }
...
%struct.anon.13 = type { i8, i32, i32 }
%struct.request_v3 = type { i32, i32, i32, %struct.sockaddr_un }
...
$_ZN9UMLSwitchD2Ev = comdat any

$_ZN9UMLSwitchD0Ev = comdat any

$_ZNK9UMLSwitch10class_nameEv = comdat any

$_ZNK6Socket10port_countEv = comdat any

$_ZNK9UMLSwitch10processingEv = comdat any

$_ZNK9UMLSwitch9flow_codeEv = comdat any
...
@.str.1 = private unnamed_addr constant [32 x i8] c"could not create control socket\00", align 1
@.str.2 = private unnamed_addr constant [43 x i8] c"path to uml_switch control socket too long\00", align 1
@.str.3 = private unnamed_addr constant [43 x i8] c"could not connect to control socket %s: %s\00", align 1
@.str.4 = private unnamed_addr constant [33 x i8] c"control setup request failed: %s\00", align 1
@.str.5 = private unnamed_addr constant [31 x i8] c"read of data socket failed: %s\00", align 1
@.str.6 = private unnamed_addr constant [11 x i8] c"UNIX_DGRAM\00", align 1
@.str.7 = private unnamed_addr constant [12 x i8] c"CLIENT true\00", align 1
@_ZTV9UMLSwitch = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI9UMLSwitch to i8*), i8* bitcast (void (%class.UMLSwitch*)* @_ZN9UMLSwitchD2Ev to i8*), i8* bitcast (void (%class.UMLSwitch*)* @_ZN9UMLSwitchD0Ev to i8*), i8* bitcast (void (%class.Socket*, i32, %class.Packet*)* @_ZN6Socket4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Socket*, %class.Task*)* @_ZN6Socket8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Socket*, i32, i32)* @_ZN6Socket8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.UMLSwitch*)* @_ZNK9UMLSwitch10class_nameEv to i8*), i8* bitcast (i8* (%class.Socket*)* @_ZNK6Socket10port_countEv to i8*), i8* bitcast (i8* (%class.UMLSwitch*)* @_ZNK9UMLSwitch10processingEv to i8*), i8* bitcast (i8* (%class.UMLSwitch*)* @_ZNK9UMLSwitch9flow_codeEv to i8*), i8* bitcast (i8* (%class.Socket*)* @_ZNK6Socket5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.UMLSwitch*, %class.Vector.8*, %class.ErrorHandler*)* @_ZN9UMLSwitch9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Socket*)* @_ZN6Socket12add_handlersEv to i8*), i8* bitcast (i32 (%class.UMLSwitch*, %class.ErrorHandler*)* @_ZN9UMLSwitch10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.UMLSwitch*, i32)* @_ZN9UMLSwitch7cleanupEN7Element12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.8*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS9UMLSwitch = constant [11 x i8] c"9UMLSwitch\00"
@_ZTI6Socket = external constant i8*
@_ZTI9UMLSwitch = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_ZTS9UMLSwitch, i32 0, i32 0), i8* bitcast (i8** @_ZTI6Socket to i8*) }
...
@.str.10 = private unnamed_addr constant [10 x i8] c"UMLSwitch\00", align 1
@.str.11 = private unnamed_addr constant [8 x i8] c"0-1/0-1\00", align 1
@.str.12 = private unnamed_addr constant [4 x i8] c"l/h\00", align 1
...
define i32 @_ZN9UMLSwitch9configureER6VectorI6StringEP12ErrorHandler(%class.UMLSwitch*, %class.Vector.8* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.UMLSwitch*, align 8
  ...
  %9 = alloca i8*
  %10 = alloca i32
  store %class.UMLSwitch* %0, %class.UMLSwitch** %4, align 8
  store %class.Vector.8* %1, %class.Vector.8** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %11 = load %class.UMLSwitch*, %class.UMLSwitch** %4, align 8
  %12 = load %class.Vector.8*, %class.Vector.8** %5, align 8
  %13 = bitcast %class.UMLSwitch* %11 to %class.Element*
  %14 = load %class.ErrorHandler*, %class.ErrorHandler** %6, align 8
  call void @_ZN4ArgsC1ERK6VectorI6StringEPK7ElementP12ErrorHandler(%class.Args* %7, %class.Vector.8* dereferenceable(16) %12, %class.Element* %13, %class.ErrorHandler* %14)
  %15 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %11, i32 0, i32 4
  %16 = invoke dereferenceable(112) %class.Args* @_ZN4Args6read_pI11FilenameArg6StringEERS_PKcT_RT0_(%class.Args* %7, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), %class.String* dereferenceable(24) %15)
...
; <label>:19:                                     ; preds = %17
  call void @_ZN4ArgsD1Ev(%class.Args* %7) #12
  ret i32 %18
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN9UMLSwitch10initializeEP12ErrorHandler(%class.UMLSwitch*, %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %3 = alloca %class.UMLSwitch*, align 8
  ...
  %8 = alloca i8*
  %9 = alloca i32
  %10 = alloca %struct.anon.13, align 4
  %11 = alloca %class.Timestamp, align 8
  %12 = alloca %struct.request_v3, align 4
  ...
  store %class.UMLSwitch* %0, %class.UMLSwitch** %3, align 8
  store %class.ErrorHandler* %1, %class.ErrorHandler** %4, align 8
  %27 = load %class.UMLSwitch*, %class.UMLSwitch** %3, align 8
  store i32 0, i32* %5, align 4
  call void @_ZN6VectorI6StringEC2Ev(%class.Vector.8* %7)
  %28 = call i32 @socket(i32 1, i32 1, i32 0) #12
  %29 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 5
  store i32 %28, i32* %29, align 8
  %30 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 5
  %31 = load i32, i32* %30, align 8
  %32 = icmp slt i32 %31, 0
  br i1 %32, label %33, label %41

; <label>:33:                                     ; preds = %2
  %34 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %35 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %34, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i32 0, i32 0))
...
; <label>:37:                                     ; preds = %169, %163, %161, %150, %139, %137, %130, %122, %115, %94, %90, %85, %79, %75, %62, %58, %52, %48, %41, %33
...
; <label>:41:                                     ; preds = %2
  %42 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 1
  %43 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %42, i32 0, i32 0
  store i16 1, i16* %43, align 8
  %44 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 4
  %45 = invoke i32 @_ZNK6String6lengthEv(%class.String* %44)
          to label %46 unwind label %37

; <label>:46:                                     ; preds = %41
  %47 = icmp sge i32 %45, 108
  br i1 %47, label %48, label %52

; <label>:48:                                     ; preds = %46
  %49 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %50 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %49, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0))
...
; <label>:52:                                     ; preds = %46
  %53 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 1
  %54 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %53, i32 0, i32 1
  %55 = getelementptr inbounds [108 x i8], [108 x i8]* %54, i32 0, i32 0
  %56 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 4
  %57 = invoke i8* @_ZNK6String5c_strEv(%class.String* %56)
          to label %58 unwind label %37

; <label>:58:                                     ; preds = %52
  %59 = call i8* @strcpy(i8* %55, i8* %57) #12
  %60 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 4
  %61 = invoke i32 @_ZNK6String6lengthEv(%class.String* %60)
...
; <label>:62:                                     ; preds = %58
  ...
  %67 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 5
  %68 = load i32, i32* %67, align 8
  %69 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 1
  %70 = bitcast %struct.sockaddr_un* %69 to %struct.sockaddr*
  %71 = load i32, i32* %6, align 4
  %72 = invoke i32 @connect(i32 %68, %struct.sockaddr* %70, i32 %71)
...
; <label>:75:                                     ; preds = %73
  %76 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %77 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 4
  %78 = invoke i8* @_ZNK6String5c_strEv(%class.String* %77)
          to label %79 unwind label %37

; <label>:79:                                     ; preds = %75
  %80 = call i32* @__errno_location() #13
  %81 = load i32, i32* %80, align 4
  %82 = call i8* @strerror(i32 %81) #12
  %83 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %76, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3, i32 0, i32 0), i8* %78, i8* %82)
...
; <label>:85:                                     ; preds = %73
  %86 = getelementptr inbounds %struct.anon.13, %struct.anon.13* %10, i32 0, i32 0
  store i8 0, i8* %86, align 4
  %87 = call i32 @getpid() #12
  %88 = getelementptr inbounds %struct.anon.13, %struct.anon.13* %10, i32 0, i32 1
  store i32 %87, i32* %88, align 4
  %89 = invoke i64 @_ZN9Timestamp3nowEv()
          to label %90 unwind label %37

; <label>:90:                                     ; preds = %85
  %91 = getelementptr inbounds %class.Timestamp, %class.Timestamp* %11, i32 0, i32 0
  %92 = getelementptr inbounds %"union.Timestamp::rep_t", %"union.Timestamp::rep_t"* %91, i32 0, i32 0
  store i64 %89, i64* %92, align 8
  %93 = invoke i32 @_ZNK9Timestamp4usecEv(%class.Timestamp* %11)
          to label %94 unwind label %37

; <label>:94:                                     ; preds = %90
  %95 = getelementptr inbounds %struct.anon.13, %struct.anon.13* %10, i32 0, i32 2
  store i32 %93, i32* %95, align 4
  %96 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 2
  %97 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %96, i32 0, i32 0
  store i16 1, i16* %97, align 2
  %98 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 2
  %99 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %98, i32 0, i32 1
  %100 = getelementptr inbounds [108 x i8], [108 x i8]* %99, i32 0, i32 0
  %101 = bitcast %struct.anon.13* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %100, i8* %101, i64 12, i32 2, i1 false)
  %102 = getelementptr inbounds %struct.request_v3, %struct.request_v3* %12, i32 0, i32 0
  store i32 -17958194, i32* %102, align 4
  %103 = getelementptr inbounds %struct.request_v3, %struct.request_v3* %12, i32 0, i32 1
  store i32 3, i32* %103, align 4
  %104 = getelementptr inbounds %struct.request_v3, %struct.request_v3* %12, i32 0, i32 2
  store i32 0, i32* %104, align 4
  %105 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 2
  %106 = getelementptr inbounds %struct.request_v3, %struct.request_v3* %12, i32 0, i32 3
  %107 = bitcast %struct.sockaddr_un* %106 to i8*
  %108 = bitcast %struct.sockaddr_un* %105 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %107, i8* %108, i64 110, i32 2, i1 false)
  %109 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 5
  %110 = load i32, i32* %109, align 8
  %111 = bitcast %struct.request_v3* %12 to i8*
  %112 = invoke i64 @write(i32 %110, i8* %111, i64 124)
          to label %113 unwind label %37

; <label>:113:                                    ; preds = %94
  %114 = icmp ne i64 %112, 124
  br i1 %114, label %115, label %122

; <label>:115:                                    ; preds = %113
  %116 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %117 = call i32* @__errno_location() #13
  %118 = load i32, i32* %117, align 4
  %119 = call i8* @strerror(i32 %118) #12
  %120 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %116, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i32 0, i32 0), i8* %119)
...
; <label>:122:                                    ; preds = %113
  %123 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 5
  %124 = load i32, i32* %123, align 8
  %125 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 3
  %126 = bitcast %struct.sockaddr_un* %125 to i8*
  %127 = invoke i64 @read(i32 %124, i8* %126, i64 110)
          to label %128 unwind label %37

; <label>:128:                                    ; preds = %122
  %129 = icmp ne i64 %127, 110
  br i1 %129, label %130, label %137

; <label>:130:                                    ; preds = %128
  %131 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %132 = call i32* @__errno_location() #13
  %133 = load i32, i32* %132, align 4
  %134 = call i8* @strerror(i32 %133) #12
  %135 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %131, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0), i8* %134)
...
; <label>:137:                                    ; preds = %128
  ...
  invoke void @_ZN6StringC2EPKc(%class.String* %13, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0))
          to label %138 unwind label %37

; <label>:138:                                    ; preds = %137
  invoke void @_ZN6VectorI6StringE9push_backI13fast_argumentIS0_Lb1EEEENT_23enable_rvalue_referenceEOS0_(%class.Vector.8* %7, %class.String* dereferenceable(24) %13)
          to label %139 unwind label %176

; <label>:139:                                    ; preds = %138
  call void @_ZN6StringD2Ev(%class.String* %13) #12
  invoke void @_ZN6StringC2Ec(%class.String* %16, i8 signext 34)
          to label %140 unwind label %37

; <label>:140:                                    ; preds = %139
  %141 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 3
  %142 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %141, i32 0, i32 1
  %143 = getelementptr inbounds [108 x i8], [108 x i8]* %142, i32 0, i32 0
  %144 = load i32, i32* %6, align 4
  invoke void @_ZN6String11make_stableEPKci(%class.String* sret %18, i8* %143, i32 %144)
          to label %145 unwind label %180

; <label>:145:                                    ; preds = %140
  invoke void @_ZNK6String10quoted_hexEv(%class.String* sret %17, %class.String* %18)
...
; <label>:147:                                    ; preds = %146
  invoke void @_ZN6StringC2Ec(%class.String* %19, i8 signext 34)
          to label %148 unwind label %192

; <label>:148:                                    ; preds = %147
  invoke void @_Zpl6StringRKS_(%class.String* sret %14, %class.String* %15, %class.String* dereferenceable(24) %19)
          to label %149 unwind label %196

; <label>:149:                                    ; preds = %148
  invoke void @_ZN6VectorI6StringE9push_backI13fast_argumentIS0_Lb1EEEENT_23enable_rvalue_referenceEOS0_(%class.Vector.8* %7, %class.String* dereferenceable(24) %14)
...
; <label>:150:                                    ; preds = %149
  ...
  invoke void @_ZN6StringC2Ec(%class.String* %22, i8 signext 34)
          to label %151 unwind label %37

; <label>:151:                                    ; preds = %150
  %152 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %27, i32 0, i32 2
  %153 = getelementptr inbounds %struct.sockaddr_un, %struct.sockaddr_un* %152, i32 0, i32 1
  %154 = getelementptr inbounds [108 x i8], [108 x i8]* %153, i32 0, i32 0
  %155 = load i32, i32* %6, align 4
  invoke void @_ZN6String11make_stableEPKci(%class.String* sret %24, i8* %154, i32 %155)
          to label %156 unwind label %209

; <label>:156:                                    ; preds = %151
  invoke void @_ZNK6String10quoted_hexEv(%class.String* sret %23, %class.String* %24)
          to label %157 unwind label %213

; <label>:157:                                    ; preds = %156
  invoke void @_Zpl6StringRKS_(%class.String* sret %21, %class.String* %22, %class.String* dereferenceable(24) %23)
          to label %158 unwind label %217

; <label>:158:                                    ; preds = %157
  invoke void @_ZN6StringC2Ec(%class.String* %25, i8 signext 34)
          to label %159 unwind label %221

; <label>:159:                                    ; preds = %158
  invoke void @_Zpl6StringRKS_(%class.String* sret %20, %class.String* %21, %class.String* dereferenceable(24) %25)
          to label %160 unwind label %225

; <label>:160:                                    ; preds = %159
  invoke void @_ZN6VectorI6StringE9push_backI13fast_argumentIS0_Lb1EEEENT_23enable_rvalue_referenceEOS0_(%class.Vector.8* %7, %class.String* dereferenceable(24) %20)
...
; <label>:161:                                    ; preds = %160
  ...
  invoke void @_ZN6StringC2EPKc(%class.String* %26, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.7, i32 0, i32 0))
          to label %162 unwind label %37

; <label>:162:                                    ; preds = %161
  invoke void @_ZN6VectorI6StringE9push_backI13fast_argumentIS0_Lb1EEEENT_23enable_rvalue_referenceEOS0_(%class.Vector.8* %7, %class.String* dereferenceable(24) %26)
          to label %163 unwind label %238

; <label>:163:                                    ; preds = %162
  call void @_ZN6StringD2Ev(%class.String* %26) #12
  %164 = bitcast %class.UMLSwitch* %27 to %class.Socket*
  %165 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %166 = invoke i32 @_ZN6Socket9configureER6VectorI6StringEP12ErrorHandler(%class.Socket* %164, %class.Vector.8* dereferenceable(16) %7, %class.ErrorHandler* %165)
...
; <label>:169:                                    ; preds = %167
  %170 = bitcast %class.UMLSwitch* %27 to %class.Socket*
  %171 = load %class.ErrorHandler*, %class.ErrorHandler** %4, align 8
  %172 = invoke i32 @_ZN6Socket10initializeEP12ErrorHandler(%class.Socket* %170, %class.ErrorHandler* %171)
...
; <label>:243:                                    ; preds = %242, %175, %136, %121, %84, %51, %36
  %244 = load i32, i32* %5, align 4
  call void @_ZN6VectorI6StringED2Ev(%class.Vector.8* %7) #12
  ret i32 %244

; <label>:245:                                    ; preds = %238, %237, %208, %176, %37
  call void @_ZN6VectorI6StringED2Ev(%class.Vector.8* %7) #12
  br label %246
...
declare i32 @_ZN6Socket9configureER6VectorI6StringEP12ErrorHandler(%class.Socket*, %class.Vector.8* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #1

declare i32 @_ZN6Socket10initializeEP12ErrorHandler(%class.Socket*, %class.ErrorHandler*) unnamed_addr #1

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN6VectorI6StringED2Ev(%class.Vector.8*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.Vector.8*, align 8
  store %class.Vector.8* %0, %class.Vector.8** %2, align 8
  %3 = load %class.Vector.8*, %class.Vector.8** %2, align 8
  %4 = getelementptr inbounds %class.Vector.8, %class.Vector.8* %3, i32 0, i32 0
  call void @_ZN13vector_memoryI18typed_array_memoryI6StringEED2Ev(%class.vector_memory.9* %4) #12
  ret void
}

; Function Attrs: noinline optnone uwtable
define void @_ZN9UMLSwitch7cleanupEN7Element12CleanupStageE(%class.UMLSwitch*, i32) unnamed_addr #0 align 2 {
  %3 = alloca %class.UMLSwitch*, align 8
  %4 = alloca i32, align 4
  store %class.UMLSwitch* %0, %class.UMLSwitch** %3, align 8
  store i32 %1, i32* %4, align 4
  %5 = load %class.UMLSwitch*, %class.UMLSwitch** %3, align 8
  %6 = bitcast %class.UMLSwitch* %5 to %class.Socket*
  %7 = load i32, i32* %4, align 4
  call void @_ZN6Socket7cleanupEN7Element12CleanupStageE(%class.Socket* %6, i32 %7)
  %8 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %5, i32 0, i32 5
  %9 = load i32, i32* %8, align 8
  %10 = icmp sge i32 %9, 0
  br i1 %10, label %11, label %15

; <label>:11:                                     ; preds = %2
  %12 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %5, i32 0, i32 5
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9UMLSwitchD2Ev(%class.UMLSwitch*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.UMLSwitch*, align 8
  store %class.UMLSwitch* %0, %class.UMLSwitch** %2, align 8
  %3 = load %class.UMLSwitch*, %class.UMLSwitch** %2, align 8
  %4 = bitcast %class.UMLSwitch* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV9UMLSwitch, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %4, align 8
  %5 = getelementptr inbounds %class.UMLSwitch, %class.UMLSwitch* %3, i32 0, i32 4
  call void @_ZN6StringD2Ev(%class.String* %5) #12
  %6 = bitcast %class.UMLSwitch* %3 to %class.Socket*
  call void @_ZN6SocketD2Ev(%class.Socket* %6) #12
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN9UMLSwitchD0Ev(%class.UMLSwitch*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.UMLSwitch*, align 8
  store %class.UMLSwitch* %0, %class.UMLSwitch** %2, align 8
  %3 = load %class.UMLSwitch*, %class.UMLSwitch** %2, align 8
  call void @_ZN9UMLSwitchD2Ev(%class.UMLSwitch* %3) #12
  %4 = bitcast %class.UMLSwitch* %3 to i8*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9UMLSwitch10class_nameEv(%class.UMLSwitch*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.UMLSwitch*, align 8
  store %class.UMLSwitch* %0, %class.UMLSwitch** %2, align 8
  %3 = load %class.UMLSwitch*, %class.UMLSwitch** %2, align 8
...
define linkonce_odr i8* @_ZNK6Socket10port_countEv(%class.Socket*) unnamed_addr #3 comdat align 2 {
  ...
  ret i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9UMLSwitch10processingEv(%class.UMLSwitch*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.UMLSwitch*, align 8
  store %class.UMLSwitch* %0, %class.UMLSwitch** %2, align 8
  %3 = load %class.UMLSwitch*, %class.UMLSwitch** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK9UMLSwitch9flow_codeEv(%class.UMLSwitch*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.UMLSwitch*, align 8
  store %class.UMLSwitch* %0, %class.UMLSwitch** %2, align 8
  %3 = load %class.UMLSwitch*, %class.UMLSwitch** %2, align 8
...
define linkonce_odr i8* @_ZNK6Socket5flagsEv(%class.Socket*) unnamed_addr #3 comdat align 2 {
  ...
  store %class.Socket* %0, %class.Socket** %2, align 8
  %3 = load %class.Socket*, %class.Socket** %2, align 8
  ret i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.14, i32 0, i32 0)
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13vector_memoryI18typed_array_memoryI6StringEED2Ev(%class.vector_memory.9*) unnamed_addr #3 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; <label>:31:                                     ; preds = %13
  ...
  call void (%class.ArgContext*, i8*, ...) @_ZNK10ArgContext5errorEPKcz(%class.ArgContext* %32, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.15, i32 0, i32 0))
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN13vector_memoryI18typed_array_memoryI6StringEEC2Ev(%class.vector_memory.9*) unnamed_addr #3 comdat align 2 {
  %2 = alloca %class.vector_memory.9*, align 8
  store %class.vector_memory.9* %0, %class.vector_memory.9** %2, align 8
  %3 = load %class.vector_memory.9*, %class.vector_memory.9** %2, align 8
  %4 = getelementptr inbounds %class.vector_memory.9, %class.vector_memory.9* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr zeroext i1 @_ZNK13vector_memoryI18typed_array_memoryI6StringEE18need_argument_copyEPKS1_(%class.vector_memory.9*, %class.String*) #3 comdat align 2 {
  %3 = alloca %class.vector_memory.9*, align 8
  %4 = alloca %class.String*, align 8
  store %class.vector_memory.9* %0, %class.vector_memory.9** %3, align 8
  store %class.String* %1, %class.String** %4, align 8
