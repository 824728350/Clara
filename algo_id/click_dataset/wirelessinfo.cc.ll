; ModuleID = '../../click/elements/wifi/wirelessinfo.cc'
source_filename = "../../click/elements/wifi/wirelessinfo.cc"
...
%class.WirelessInfo = type <{ %class.Element.base, [4 x i8], %class.String, %class.EtherAddress, [2 x i8], i32, i32, i8, [7 x i8] }>
...
$_ZNK12WirelessInfo10class_nameEv = comdat any

$_ZNK12WirelessInfo10port_countEv = comdat any
...
@_ZTV12WirelessInfo = unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI12WirelessInfo to i8*), i8* bitcast (void (%class.WirelessInfo*)* @_ZN12WirelessInfoD1Ev to i8*), i8* bitcast (void (%class.WirelessInfo*)* @_ZN12WirelessInfoD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.WirelessInfo*)* @_ZNK12WirelessInfo10class_nameEv to i8*), i8* bitcast (i8* (%class.WirelessInfo*)* @_ZNK12WirelessInfo10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.WirelessInfo*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN12WirelessInfo9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.WirelessInfo*)* @_ZN12WirelessInfo12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector.0*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
...
@.str.7 = private unnamed_addr constant [41 x i8] c"bssid parameter must be ethernet address\00", align 1
@.str.8 = private unnamed_addr constant [30 x i8] c"channel parameter must be int\00", align 1
@.str.9 = private unnamed_addr constant [31 x i8] c"interval parameter must be int\00", align 1
@.str.10 = private unnamed_addr constant [30 x i8] c"wep parameter must be boolean\00", align 1
@.str.11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.12 = private unnamed_addr constant [5 x i8] c"ssid\00", align 1
@.str.13 = private unnamed_addr constant [6 x i8] c"bssid\00", align 1
@.str.14 = private unnamed_addr constant [8 x i8] c"channel\00", align 1
@.str.15 = private unnamed_addr constant [9 x i8] c"interval\00", align 1
@.str.16 = private unnamed_addr constant [4 x i8] c"wep\00", align 1
@.str.17 = private unnamed_addr constant [6 x i8] c"reset\00", align 1
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS12WirelessInfo = constant [15 x i8] c"12WirelessInfo\00"
@_ZTI7Element = external constant i8*
@_ZTI12WirelessInfo = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @_ZTS12WirelessInfo, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }
...
@.str.20 = private unnamed_addr constant [13 x i8] c"WirelessInfo\00", align 1
...
@_ZN12WirelessInfoC1Ev = alias void (%class.WirelessInfo*), void (%class.WirelessInfo*)* @_ZN12WirelessInfoC2Ev
@_ZN12WirelessInfoD1Ev = alias void (%class.WirelessInfo*), void (%class.WirelessInfo*)* @_ZN12WirelessInfoD2Ev

; Function Attrs: noinline optnone uwtable
define void @_ZN12WirelessInfoC2Ev(%class.WirelessInfo*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %class.WirelessInfo*, align 8
  %3 = alloca i8*
  %4 = alloca i32
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %5 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  %6 = bitcast %class.WirelessInfo* %5 to %class.Element*
  call void @_ZN7ElementC2Ev(%class.Element* %6)
  %7 = bitcast %class.WirelessInfo* %5 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12WirelessInfo, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %7, align 8
  %8 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %5, i32 0, i32 2
  invoke void @_ZN6StringC2EPKc(%class.String* %8, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0))
          to label %9 unwind label %15

; <label>:9:                                      ; preds = %1
  %10 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %5, i32 0, i32 3
  invoke void @_ZN12EtherAddressC2EPKh(%class.EtherAddress* %10, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0))
          to label %11 unwind label %19

; <label>:11:                                     ; preds = %9
  %12 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %5, i32 0, i32 5
  store i32 -1, i32* %12, align 8
  %13 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %5, i32 0, i32 6
  store i32 100, i32* %13, align 4
  %14 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %5, i32 0, i32 7
...
; <label>:23:                                     ; preds = %19, %15
  %24 = bitcast %class.WirelessInfo* %5 to %class.Element*
...
; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN12WirelessInfoD2Ev(%class.WirelessInfo*) unnamed_addr #2 align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %3 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  %4 = bitcast %class.WirelessInfo* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12WirelessInfo, i32 0, inrange i32 0, i32 2) to i32 (...)**), i32 (...)*** %4, align 8
  %5 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %3, i32 0, i32 2
  call void @_ZN6StringD2Ev(%class.String* %5) #11
  %6 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7ElementD2Ev(%class.Element* %6) #11
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define void @_ZN12WirelessInfoD0Ev(%class.WirelessInfo*) unnamed_addr #2 align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %3 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  call void @_ZN12WirelessInfoD1Ev(%class.WirelessInfo* %3) #11
  %4 = bitcast %class.WirelessInfo* %3 to i8*
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12WirelessInfo9configureER6VectorI6StringEP12ErrorHandler(%class.WirelessInfo*, %class.Vector.0* dereferenceable(16), %class.ErrorHandler*) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.WirelessInfo*, align 8
  ...
  %9 = alloca i8*
  %10 = alloca i32
  store %class.WirelessInfo* %0, %class.WirelessInfo** %4, align 8
  store %class.Vector.0* %1, %class.Vector.0** %5, align 8
  store %class.ErrorHandler* %2, %class.ErrorHandler** %6, align 8
  %11 = load %class.WirelessInfo*, %class.WirelessInfo** %4, align 8
  call void @_ZN12WirelessInfo5resetEv(%class.WirelessInfo* %11)
  %12 = load %class.Vector.0*, %class.Vector.0** %5, align 8
  %13 = bitcast %class.WirelessInfo* %11 to %class.Element*
  ...
  %15 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %11, i32 0, i32 2
  %16 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readI6StringEERS_PKcRT_(%class.Args* %8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), %class.String* dereferenceable(24) %15)
          to label %17 unwind label %33

; <label>:17:                                     ; preds = %3
  %18 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %11, i32 0, i32 3
  %19 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readI12EtherAddressEERS_PKcRT_(%class.Args* %16, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0), %class.EtherAddress* dereferenceable(6) %18)
          to label %20 unwind label %33

; <label>:20:                                     ; preds = %17
  %21 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %11, i32 0, i32 5
  %22 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readIiEERS_PKcRT_(%class.Args* %19, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i32* dereferenceable(4) %21)
          to label %23 unwind label %33

; <label>:23:                                     ; preds = %20
  %24 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %11, i32 0, i32 6
  %25 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readIiEERS_PKcRT_(%class.Args* %22, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i32 0, i32 0), i32* dereferenceable(4) %24)
          to label %26 unwind label %33

; <label>:26:                                     ; preds = %23
  %27 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %11, i32 0, i32 7
  %28 = invoke dereferenceable(112) %class.Args* @_ZN4Args4readIbEERS_PKcRT_(%class.Args* %25, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0), i8* dereferenceable(1) %27)
...
; <label>:33:                                     ; preds = %29, %26, %23, %20, %17, %3
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12WirelessInfo5resetEv(%class.WirelessInfo*) #0 align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  %3 = alloca %class.EtherAddress, align 1
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %4 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  %5 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %4, i32 0, i32 2
  %6 = call dereferenceable(24) %class.String* @_ZN6StringaSEPKc(%class.String* %5, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i32 0, i32 0))
  %7 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %4, i32 0, i32 5
  store i32 -1, i32* %7, align 8
  call void @_ZN12EtherAddressC2Ev(%class.EtherAddress* %3)
  %8 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %4, i32 0, i32 3
  %9 = bitcast %class.EtherAddress* %8 to i8*
  %10 = bitcast %class.EtherAddress* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %9, i8* %10, i64 6, i32 1, i1 false)
  %11 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %4, i32 0, i32 6
  store i32 100, i32* %11, align 4
  %12 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %4, i32 0, i32 7
...
; Function Attrs: noinline optnone uwtable
define i32 @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler(%class.String* dereferenceable(24), %class.Element*, i8*, %class.ErrorHandler*) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %5 = alloca i32, align 4
  %6 = alloca %class.String*, align 8
  %7 = alloca %class.Element*, align 8
  %8 = alloca i8*, align 8
  %9 = alloca %class.ErrorHandler*, align 8
  %10 = alloca %class.WirelessInfo*, align 8
  ...
  %23 = load %class.Element*, %class.Element** %7, align 8
  %24 = bitcast %class.Element* %23 to %class.WirelessInfo*
  store %class.WirelessInfo* %24, %class.WirelessInfo** %10, align 8
  %25 = load %class.String*, %class.String** %6, align 8
  call void @_Z12cp_uncommentRK6String(%class.String* sret %11, %class.String* dereferenceable(24) %25)
  %26 = load i8*, i8** %8, align 8
  %27 = ptrtoint i8* %26 to i64
  switch i64 %27, label %95 [
    i64 0, label %28
    i64 1, label %37
    i64 2, label %52
    i64 3, label %65
...
; <label>:28:                                     ; preds = %4
  %29 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  %30 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %29, i32 0, i32 2
  %31 = invoke dereferenceable(24) %class.String* @_ZN6StringaSERKS_(%class.String* %30, %class.String* dereferenceable(24) %11)
          to label %32 unwind label %33

; <label>:32:                                     ; preds = %28
  br label %95

; <label>:33:                                     ; preds = %92, %82, %78, %70, %66, %65, %57, %53, %52, %43, %39, %38, %37, %28
  %34 = landingpad { i8*, i32 }
          cleanup
  %35 = extractvalue { i8*, i32 } %34, 0
...
; <label>:39:                                     ; preds = %38
  %40 = invoke zeroext i1 @_ZN15EtherAddressArg5parseERK6StringR12EtherAddressRK10ArgContext(%class.EtherAddressArg* %15, %class.String* dereferenceable(24) %11, %class.EtherAddress* dereferenceable(6) %14, %class.ArgContext* dereferenceable(32) @blank_args)
...
; <label>:43:                                     ; preds = %41
  ...
  %45 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %44, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i32 0, i32 0))
...
; <label>:47:                                     ; preds = %41
  %48 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  %49 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %48, i32 0, i32 3
  %50 = bitcast %class.EtherAddress* %49 to i8*
  %51 = bitcast %class.EtherAddress* %14 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %50, i8* %51, i64 6, i32 1, i1 false)
  br label %95
...
; <label>:53:                                     ; preds = %52
  %54 = invoke zeroext i1 @_ZN6IntArg5parseIiEEbRK6StringRT_RK10ArgContext(%class.IntArg* %18, %class.String* dereferenceable(24) %11, i32* dereferenceable(4) %17, %class.ArgContext* dereferenceable(32) @blank_args)
...
; <label>:57:                                     ; preds = %55
  %58 = load %class.ErrorHandler*, %class.ErrorHandler** %9, align 8
  %59 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %58, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.8, i32 0, i32 0))
...
; <label>:61:                                     ; preds = %55
  ...
  %63 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  %64 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %63, i32 0, i32 5
...
; <label>:66:                                     ; preds = %65
  %67 = invoke zeroext i1 @_ZN6IntArg5parseIiEEbRK6StringRT_RK10ArgContext(%class.IntArg* %20, %class.String* dereferenceable(24) %11, i32* dereferenceable(4) %19, %class.ArgContext* dereferenceable(32) @blank_args)
...
; <label>:70:                                     ; preds = %68
  ...
  %72 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %71, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.9, i32 0, i32 0))
...
; <label>:74:                                     ; preds = %68
  ...
  %76 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  %77 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %76, i32 0, i32 6
  store i32 %75, i32* %77, align 4
  br label %95

; <label>:78:                                     ; preds = %4
  %79 = invoke zeroext i1 @_ZN7BoolArg5parseERK6StringRbRK10ArgContext(%class.String* dereferenceable(24) %11, i8* dereferenceable(1) %21, %class.ArgContext* dereferenceable(32) @blank_args)
...
; <label>:82:                                     ; preds = %80
  ...
  %84 = invoke i32 (%class.ErrorHandler*, i8*, ...) @_ZN12ErrorHandler5errorEPKcz(%class.ErrorHandler* %83, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.10, i32 0, i32 0))
...
; <label>:86:                                     ; preds = %80
  ...
  %89 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  %90 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %89, i32 0, i32 7
  %91 = zext i1 %88 to i8
  store i8 %91, i8* %90, align 8
  br label %95

; <label>:92:                                     ; preds = %4
  %93 = load %class.WirelessInfo*, %class.WirelessInfo** %10, align 8
  invoke void @_ZN12WirelessInfo5resetEv(%class.WirelessInfo* %93)
          to label %94 unwind label %33

; <label>:94:                                     ; preds = %92
  br label %95

; <label>:95:                                     ; preds = %4, %94, %86, %74, %61, %47, %32
  store i32 0, i32* %5, align 4
  store i32 1, i32* %16, align 4
  br label %96

; <label>:96:                                     ; preds = %95, %85, %73, %60, %46
  call void @_ZN6StringD2Ev(%class.String* %11) #11
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12WirelessInfo10read_paramEP7ElementPv(%class.String* noalias sret, %class.Element*, i8*) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %class.WirelessInfo*, align 8
  %7 = alloca %class.String, align 8
  %8 = alloca i8*
  %9 = alloca i32
  ...
  %15 = bitcast %class.Element* %14 to %class.WirelessInfo*
  store %class.WirelessInfo* %15, %class.WirelessInfo** %6, align 8
...
; <label>:18:                                     ; preds = %3
  %19 = load %class.WirelessInfo*, %class.WirelessInfo** %6, align 8
  %20 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %19, i32 0, i32 2
  call void @_ZN6StringC2ERKS_(%class.String* %7, %class.String* dereferenceable(24) %20)
  invoke void @_Zpl6StringPKc(%class.String* sret %0, %class.String* %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
...
; <label>:26:                                     ; preds = %3
  %27 = load %class.WirelessInfo*, %class.WirelessInfo** %6, align 8
  %28 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %27, i32 0, i32 3
  call void @_ZNK12EtherAddress7unparseEv(%class.String* sret %10, %class.EtherAddress* %28)
  invoke void @_Zpl6StringPKc(%class.String* sret %0, %class.String* %10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
...
; <label>:34:                                     ; preds = %3
  %35 = load %class.WirelessInfo*, %class.WirelessInfo** %6, align 8
  %36 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %35, i32 0, i32 5
  %37 = load i32, i32* %36, align 8
  call void @_ZN6StringC1Ei(%class.String* %11, i32 %37)
  invoke void @_Zpl6StringPKc(%class.String* sret %0, %class.String* %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
...
; <label>:43:                                     ; preds = %3
  %44 = load %class.WirelessInfo*, %class.WirelessInfo** %6, align 8
  %45 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %44, i32 0, i32 6
  %46 = load i32, i32* %45, align 4
  call void @_ZN6StringC1Ei(%class.String* %12, i32 %46)
  invoke void @_Zpl6StringPKc(%class.String* sret %0, %class.String* %12, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
...
; <label>:52:                                     ; preds = %3
  %53 = load %class.WirelessInfo*, %class.WirelessInfo** %6, align 8
  %54 = getelementptr inbounds %class.WirelessInfo, %class.WirelessInfo* %53, i32 0, i32 7
  %55 = load i8, i8* %54, align 8
  %56 = trunc i8 %55 to i1
  call void @_ZN6StringC2Eb(%class.String* %13, i1 zeroext %56)
  invoke void @_Zpl6StringPKc(%class.String* sret %0, %class.String* %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
...
; <label>:62:                                     ; preds = %3
  call void @_ZN6StringC2EPKc(%class.String* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i32 0, i32 0))
  br label %63

; <label>:63:                                     ; preds = %62, %57, %47, %38, %29, %21
  ret void

; <label>:64:                                     ; preds = %58, %48, %39, %30, %22
...
; Function Attrs: noinline optnone uwtable
define void @_ZN12WirelessInfo12add_handlersEv(%class.WirelessInfo*) unnamed_addr #0 align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %3 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  %4 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZN12WirelessInfo10read_paramEP7ElementPv, i32 0, i32 0)
  %5 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %5, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.13, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZN12WirelessInfo10read_paramEP7ElementPv, i32 1, i32 0)
  %6 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %6, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.14, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZN12WirelessInfo10read_paramEP7ElementPv, i32 2, i32 0)
  %7 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZN12WirelessInfo10read_paramEP7ElementPv, i32 3, i32 0)
  %8 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element16add_read_handlerEPKcPF6StringPS_PvEij(%class.Element* %8, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.16, i32 0, i32 0), void (%class.String*, %class.Element*, i8*)* @_ZN12WirelessInfo10read_paramEP7ElementPv, i32 4, i32 0)
  %9 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 0, i32 0)
  %10 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %10, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.13, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 1, i32 0)
  %11 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %11, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.14, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 2, i32 0)
  %12 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %12, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 3, i32 0)
  %13 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %13, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.16, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 4, i32 0)
  %14 = bitcast %class.WirelessInfo* %3 to %class.Element*
  call void @_ZN7Element17add_write_handlerEPKcPFiRK6StringPS_PvP12ErrorHandlerEij(%class.Element* %14, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.17, i32 0, i32 0), i32 (%class.String*, %class.Element*, i8*, %class.ErrorHandler*)* @_ZN12WirelessInfo11write_paramERK6StringP7ElementPvP12ErrorHandler, i32 5, i32 8192)
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12WirelessInfo10class_nameEv(%class.WirelessInfo*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %3 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
  ret i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.20, i32 0, i32 0)
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr i8* @_ZNK12WirelessInfo10port_countEv(%class.WirelessInfo*) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.WirelessInfo*, align 8
  store %class.WirelessInfo* %0, %class.WirelessInfo** %2, align 8
  %3 = load %class.WirelessInfo*, %class.WirelessInfo** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr void @_ZN10DefaultArgI12EtherAddressEC2Ev(%struct.DefaultArg.20*) unnamed_addr #2 comdat align 2 {
