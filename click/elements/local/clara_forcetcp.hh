#ifndef CLICK_CLARAFORCETCP_HH
#define CLICK_CLARAFORCETCP_HH
...
class ClaraForceTCP : public Element {
public:
  ClaraForceTCP() CLICK_COLD;
  ~ClaraForceTCP() CLICK_COLD;

  const char *class_name() const		{ return "ClaraForceTCP"; }
