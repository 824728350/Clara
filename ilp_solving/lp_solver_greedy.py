...
##### ILP solver greedy####
temp_data = sorted(data_structures, key = lambda x:int(x[2]))
#list1 = [2, 5, 3]
#temp_data = sorted(list1)
#print(temp_data)
flag1 = 0
flag2 = 0
flag3 = 0
...
for item in temp_data:
    if flag1 + int(item[2]) < 4000:
        flag1 += int(item[2])
        temp_string += "prob +=" + 'x' + item[0] + "_lmem == 1\n"
    elif flag2 + int(item[2]) < 64000:
        flag2 += int(item[2])
        temp_string += "prob +=" + 'x' + item[0] + "_cls == 1\n"
    elif flag3 + int(item[2]) < 256000:
        flag3 += int(item[2])
        temp_string += "prob +=" + 'x' + item[0] + "_ctm == 1\n"
    elif flag4 + int(item[2]) < 8000000:
        flag4 += int(item[2])
        temp_string += "prob +=" + 'x' + item[0] + "_imem == 1\n"
    elif flag4 + int(item[2]) < 8000000000:
        flag4 += int(item[2])
        temp_string += "prob +=" + 'x' + item[0] + "_emem == 1\n"
#print(temp_string)
...
fn = open("lp_formula_greedy.output", "w")
...
fw = open("lp_formula_greedy.py", "w")
print("lp formula generated, greedy approach.")
fw.write(z3_program)
fw.close()
#fn.close()
