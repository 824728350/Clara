...
configs = [str(random.randint(10,35)), str(random.randint(10,35)), str(random.randint(1,5)), str(random.randint(1,5)), str(random.randint(1,5)), str(random.randint(1,5)), str(random.randint(1,5))] + [str(random.randint(1,computes)) for i in range(20)]
